...
hotcitys[0]=new Array('bj','北京','beijing','bj','15558','beijing','北京','','',12,0);

hotcitys[1]=new Array('sh','上海','shanghai','sh','16172','shanghai','上海','','',13,0);

hotcitys[3]=new Array('gz','广州','guangzhou','gz','10930','guangdong','广东','','',16,0);

hotcitys[2]=new Array('cd','成都','chengdu','cd','15504','sichuan','四川','','',45,0);

hotcitys[4]=new Array('sz','深圳','shenzhen','sz','7337','guangdong','广东','','',17,0);

hotcitys[8]=new Array('xa','西安','xian','xa','12280','shanxi','陕西','','',176,0);

hotcitys[15]=new Array('nj','南京','nanjing','nj','5758','jiangsu','江苏','','',65,0);

hotcitys[9]=new Array('hz','杭州','hangzhou','hz','7950','zhejiang','浙江','','',26,0);

hotcitys[7]=new Array('cq','重庆','chongqing','cq','13019','chongqing','重庆','','',15,0);

hotcitys[12]=new Array('wh','武汉','wuhan','wh','7817','hubei','湖北','','',194,0);

hotcitys[16]=new Array('sz','苏州','suzhou','su','5563','jiangsu','江苏','','',67,0);

hotcitys[18]=new Array('qd','青岛','qingdao','qd','11998','shandong','山东','','',114,0);

hotcitys[11]=new Array('xm','厦门','xiamen','xm','5740','fujian','福建','','',76,0);

hotcitys[6]=new Array('sy','三亚','sanya','sanya','7476','hainan','海南','','',144,0);

hotcitys[10]=new Array('heb','哈尔滨','haerbin','hrb','4080','heilongjiang','黑龙江','','',93,0);

hotcitys[14]=new Array('tj','天津','tianjin','tj','3911','tianjin','天津','','',14,0);

hotcitys[17]=new Array('km','昆明','kunming','km','3820','yunnan','云南','','',225,0);

hotcitys[5]=new Array('xg','香港','xianggang','hongkong','463','xianggang','香港','','',344,0);

hotcitys[13]=new Array('cs','长沙','changsha','cs','5415','hunan','湖南','','',204,0);
...
citys[0]=new Array('bj','北京','beijing','bj','15558','beijing','北京','','',12,0);

citys[1]=new Array('sh','上海','shanghai','sh','16172','shanghai','上海','','',13,0);

citys[2]=new Array('gz','广州','guangzhou','gz','10930','guangdong','广东','','',16,0);

citys[3]=new Array('cd','成都','chengdu','cd','15504','sichuan','四川','','',45,0);

citys[4]=new Array('sz','深圳','shenzhen','sz','7337','guangdong','广东','','',17,0);

citys[5]=new Array('xa','西安','xian','xa','12280','shanxi','陕西','','',176,0);

citys[6]=new Array('nj','南京','nanjing','nj','5758','jiangsu','江苏','','',65,0);

citys[7]=new Array('hz','杭州','hangzhou','hz','7950','zhejiang','浙江','','',26,0);

citys[8]=new Array('cq','重庆','chongqing','cq','13019','chongqing','重庆','','',15,0);

citys[9]=new Array('wh','武汉','wuhan','wh','7817','hubei','湖北','','',194,0);

citys[10]=new Array('sz','苏州','suzhou','su','5563','jiangsu','江苏','','',67,0);

citys[11]=new Array('wx','无锡','wuxi','wx','1884','jiangsu','江苏','','',66,0);

citys[12]=new Array('qd','青岛','qingdao','qd','11998','shandong','山东','','',114,0);

citys[13]=new Array('xm','厦门','xiamen','xm','5740','fujian','福建','','',76,0);

citys[14]=new Array('sy','三亚','sanya','sanya','7476','hainan','海南','','',144,0);

citys[15]=new Array('dl','大连','dalian','dl','4532','liaoning','辽宁','','',56,0);

citys[16]=new Array('heb','哈尔滨','haerbin','hrb','4080','heilongjiang','黑龙江','','',93,0);

citys[17]=new Array('qhd','秦皇岛','qinhuangdao','qinhuangdao','7079','hebei','河北','','',3,0);

citys[18]=new Array('tj','天津','tianjin','tj','3911','tianjin','天津','','',14,0);

citys[19]=new Array('km','昆明','kunming','km','3820','yunnan','云南','','',225,0);

citys[20]=new Array('xg','香港','xianggang','hongkong','463','xianggang','香港','','',344,0);

citys[21]=new Array('cc','长春','changchun','cc','1730','jilin','吉林','','',84,0);

citys[22]=new Array('sy','沈阳','shenyang','sy','3248','liaoning','辽宁','','',55,0);

citys[23]=new Array('hf','合肥','hefei','hf','1598','anhui','安徽','','',123,0);

citys[24]=new Array('zz','郑州','zhengzhou','zz','2792','henan','河南','','',103,0);

citys[25]=new Array('ty','太原','taiyuan','ty','1747','shanxi','山西','','',155,0);

citys[26]=new Array('wh','威海','weihai','wei','4255','shandong','山东','','',120,0);

citys[27]=new Array('lj','丽江','lijiang','lijiang','2924','yunnan','云南','','',230,0);

citys[28]=new Array('dl','大理','dali','dali','4675','yunnan','云南','','',237,0);

citys[29]=new Array('gl','桂林','guilin','gl','2682','guangxi','广西','','',134,0);

citys[30]=new Array('am','澳门','aomen','macao','263','aomen','澳门','','',345,0);

citys[31]=new Array('fz','福州','fuzhou','fz','1634','fujian','福建','','',75,0);

citys[32]=new Array('nb','宁波','ningbo','nb','2192','zhejiang','浙江','','',27,0);

citys[33]=new Array('zh','珠海','zhuhai','zhuhai','1694','guangdong','广东','','',18,0);

citys[34]=new Array('cs','长沙','changsha','cs','5415','hunan','湖南','','',204,0);

citys[35]=new Array('sjz','石家庄','shijiazhuang','sjz','1960','hebei','河北','','',1,0);

citys[36]=new Array('ls','拉萨','lasa','ls','308','xicang','西藏','','',256,0);

citys[37]=new Array('cz','常州','changzhou','changzhou','856','jiangsu','江苏','','',69,0);

citys[38]=new Array('yz','扬州','yangzhou','yangzhou','1206','jiangsu','江苏','','',74,0);

citys[39]=new Array('dg','东莞','dongguan','dg','764','guangdong','广东','','',24,0);

citys[40]=new Array('hk','海口','haikou','hn','1832','hainan','海南','','',143,0);

citys[41]=new Array('lz','兰州','lanzhou','lz','1427','gansu','甘肃','','',166,0);

citys[42]=new Array('ly','洛阳','luoyang','luoyang','1337','henan','河南','','',104,0);

citys[43]=new Array('wlmq','乌鲁木齐','wulumuqi','xj','299','xinjiang','新疆','','',241,0);

citys[44]=new Array('xz','徐州','xuzhou','xuzhou','701','jiangsu','江苏','','',68,0);

citys[45]=new Array('gy','贵阳','guiyang','gy','2092','guizhou','贵州','','',36,0);

citys[46]=new Array('hhht','呼和浩特','huhehaote','nmg','803','neimenggu','内蒙古','','',145,0);

citys[47]=new Array('jn','济南','jinan','jn','1991','shandong','山东','','',113,0);

citys[48]=new Array('ts','唐山','tangshan','tangshan','1139','hebei','河北','','',2,0);

citys[49]=new Array('bd','保定','baoding','baoding','1067','hebei','河北','','',6,0);

citys[50]=new Array('nc','南昌','nanchang','nc','1354','jiangxi','江西','','',214,0);

citys[51]=new Array('hd','邯郸','handan','handan','279','hebei','河北','','',4,0);

citys[52]=new Array('nn','南宁','nanning','nn','1813','guangxi','广西','','',142,0);

citys[53]=new Array('wf','潍坊','weifang','weifang','553','shandong','山东','','',119,0);

citys[54]=new Array('jz','锦州','jinzhou','jinzhou','467','liaoning','辽宁','','',60,0);

citys[55]=new Array('rz','日照','rizhao','rizhao','1991','shandong','山东','','',306,0);

citys[56]=new Array('ly','临沂','linyi','linyi','376','shandong','山东','','',307,0);

citys[57]=new Array('as','鞍山','anshan','anshan','131','liaoning','辽宁','','',57,0);

citys[58]=new Array('lf','廊坊','langfang','langfang','896','hebei','河北','','',10,0);

citys[59]=new Array('dq','大庆','daqing','daqing','283','heilongjiang','黑龙江','','',98,0);

citys[60]=new Array('bh','北海','beihai','beihai','4308','guangxi','广西','','',317,0);

citys[61]=new Array('zs','中山','zhongshan','zhongshan','445','guangdong','广东','','',25,0);

citys[62]=new Array('xn','西宁','xining','xn','1142','qinghai','青海','','',186,0);

citys[63]=new Array('jh','金华','jinhua','jinhua','861','zhejiang','浙江','','',32,0);

citys[64]=new Array('dd','丹东','dandong','dandong','1178','liaoning','辽宁','','',59,0);

citys[65]=new Array('cd','承德','chengde','chengde','2613','hebei','河北','','',8,0);

citys[66]=new Array('pj','盘锦','panjin','panjin','397','liaoning','辽宁','','',63,0);

citys[67]=new Array('zb','淄博','zibo','zibo','319','shandong','山东','','',115,0);

citys[68]=new Array('zz','株洲','zhuzhou','zhuzhou','318','hunan','湖南','','',205,0);

citys[69]=new Array('fs','佛山','foshan','foshan','1409','guangdong','广东','','',20,0);

citys[70]=new Array('jl','吉林','jilinshi','jilin','536','jilin','吉林','','',85,0);

citys[71]=new Array('yl','玉林','yulin','gxyulin','36','guangxi','广西','','',138,0);

citys[72]=new Array('xt','邢台','xingtai','xingtai','225','hebei','河北','','',5,0);

citys[73]=new Array('qqhe','齐齐哈尔','qiqihaer','qiqihaer','224','heilongjiang','黑龙江','','',94,0);

citys[74]=new Array('yc','宜昌','yichang','yichang','824','hubei','湖北','','',199,0);

citys[75]=new Array('dt','大同','datong','datong','780','shanxi','山西','','',156,0);

citys[76]=new Array('yt','烟台','yantai','yantai','4426','shandong','山东','','',118,0);

citys[77]=new Array('yc','银川','yinchuan','yc','442','ningxia','宁夏','','',165,0);

citys[78]=new Array('wz','温州','wenzhou','wenzhou','1198','zhejiang','浙江','','',28,0);

citys[79]=new Array('ha','淮安','huaian','huaian','165','jiangsu','江苏','','',72,0);

citys[80]=new Array('my','绵阳','mianyang','mianyang','485','sichuan','四川','','',49,0);

citys[81]=new Array('bt','包头','baotou','baotou','310','neimenggu','内蒙古','','',146,0);

citys[82]=new Array('fs','抚顺','fushun','fushun','138','liaoning','辽宁','','',58,0);

citys[83]=new Array('ta','泰安','taian','taian','634','shandong','山东','','',305,0);

citys[84]=new Array('jn','济宁','jining','jining','415','shandong','山东','','',304,0);

citys[85]=new Array('lyg','连云港','lianyungang','lianyungang','556','jiangsu','江苏','','',71,0);

citys[86]=new Array('hnz','海南州','hainan','hainanzhou','68','qinghai','青海','','',190,0);

citys[87]=new Array('qz','泉州','quanzhou','quanzhou','693','fujian','福建','','',79,0);

citys[88]=new Array('ay','安阳','anyang','anyang','161','henan','河南','','',109,0);

citys[89]=new Array('hz','惠州','huizhou','huizhou','7280','guangdong','广东','','',23,0);

citys[90]=new Array('hld','葫芦岛','huludao','huludao','3485','liaoning','辽宁','','',64,0);

citys[91]=new Array('jx','嘉兴','jiaxing','jiaxing','2416','zhejiang','浙江','','',29,0);

citys[92]=new Array('nt','南通','nantong','nantong','840','jiangsu','江苏','','',70,0);

citys[93]=new Array('pzh','攀枝花','panzhihua','panzhihua','216','sichuan','四川','','',274,0);

citys[94]=new Array('lz','柳州','liuzhou','liuzhou','344','guangxi','广西','','',133,0);

citys[95]=new Array('dy','东营','dongying','dongying','49','shandong','山东','','',117,0);

citys[96]=new Array('jms','佳木斯','jiamusi','jiamusi','186','heilongjiang','黑龙江','','',100,0);

citys[97]=new Array('tl','通辽','tongliao','tongliao','93','neimenggu','内蒙古','','',149,0);

citys[98]=new Array('dz','德州','dezhou','dezhou','314','shandong','山东','','',308,0);

citys[99]=new Array('gz','赣州','ganzhou','ganzhou','285','jiangxi','江西','','',220,0);

citys[100]=new Array('bz','滨州','binzhou','binzhou','92','shandong','山东','','',122,0);

citys[101]=new Array('xy','咸阳','xianyang','xianyang','424','shanxi','陕西','','',179,0);

citys[102]=new Array('jm','江门','jiangmen','jiangmen','364','guangdong','广东','','',21,0);

citys[103]=new Array('zz','漳州','zhangzhou','zhangzhou','1667','fujian','福建','','',80,0);

citys[104]=new Array('xx','新乡','xinxiang','xinxiang','279','henan','河南','','',108,0);

citys[105]=new Array('xy','襄阳','xiangyang','xiangyang','133','hubei','湖北','','',196,0);

citys[106]=new Array('nc','南充','nanchong','nanchong','429','sichuan','四川','','',51,0);

citys[107]=new Array('lc','聊城','liaocheng','liaocheng','310','shandong','山东','','',309,0);

citys[108]=new Array('zjk','张家口','zhangjiakou','zhangjiakou','1100','hebei','河北','','',7,0);

citys[109]=new Array('cz','沧州','cangzhou','cangzhou','183','hebei','河北','','',9,0);
...
citys[112]=new Array('cf','赤峰','chifeng','chifeng','272','neimenggu','内蒙古','','',148,0);

citys[113]=new Array('zj','湛江','zhanjiang','zhanjiang','483','guangdong','广东','','',264,0);

citys[114]=new Array('sq','商丘','shangqiu','shangqiu','121','henan','河南','','',297,0);

citys[115]=new Array('pds','平顶山','pingdingshan','pingdingshan','66','henan','河南','','',105,0);

citys[116]=new Array('xy','信阳','xinyang','xinyang','68','henan','河南','','',298,0);

citys[117]=new Array('jj','九江','jiujiang','jiujiang','486','jiangxi','江西','','',217,0);

citys[118]=new Array('yk','营口','yingkou','yingkou','2827','liaoning','辽宁','','',61,0);

citys[119]=new Array('bx','本溪','benxi','benxi','297','liaoning','辽宁','','',286,0);

citys[120]=new Array('ly','辽阳','liaoyang','liaoyang','20','liaoning','辽宁','','',62,0);

citys[121]=new Array('qz','钦州','qinzhou','qinzhou','22','guangxi','广西','','',136,0);

citys[122]=new Array('hy','衡阳','hengyang','hengyang','425','hunan','湖南','','',207,0);

citys[123]=new Array('st','汕头','shantou','shantou','929','guangdong','广东','','',19,0);

citys[124]=new Array('wh','芜湖','wuhu','wuhu','303','anhui','安徽','','',124,0);

citys[125]=new Array('hlbe','呼伦贝尔','hulunbeier','hulunbeier','809','neimenggu','内蒙古','','',151,0);
...
citys[128]=new Array('qy','清远','qingyuan','qingyuan','1720','guangdong','广东','','',270,0);

citys[129]=new Array('sn','遂宁','suining','suining','90','sichuan','四川','','',276,0);

citys[130]=new Array('tz','泰州','taizhoujs','jstaizhou','126','jiangsu','江苏','','',291,0);

citys[131]=new Array('pt','莆田','putian','putian','186','fujian','福建','','',77,0);

citys[132]=new Array('zz','枣庄','zaozhuang','zaozhuang','612','shandong','山东','','',116,0);

citys[133]=new Array('lz','泸州','luzhou','luzhou','231','sichuan','四川','','',47,0);

citys[134]=new Array('zs','舟山','zhoushan','zhoushan','2593','zhejiang','浙江','','',34,0);

citys[135]=new Array('zj','镇江','zhenjiang','zhenjiang','321','jiangsu','江苏','','',290,0);

citys[136]=new Array('kf','开封','kaifeng','kaifeng','828','henan','河南','','',293,0);

citys[137]=new Array('eeds','鄂尔多斯','eerduosi','eerduosi','127','neimenggu','内蒙古','','',150,0);

citys[138]=new Array('sy','十堰','shiyan','shiyan','165','hubei','湖北','','',197,0);

citys[139]=new Array('yb','延边','yanbian','yanbian','762','jilin','吉林','','',92,0);

citys[140]=new Array('hb','淮北','huaibei','huaibei','66','anhui','安徽','','',311,0);

citys[141]=new Array('lf','临汾','linfen','linfen','222','shanxi','山西','','',164,0);

citys[142]=new Array('cd','常德','changde','changde','177','hunan','湖南','','',210,0);

citys[143]=new Array('jz','荆州','jingzhou','jingzhou','161','hubei','湖北','','',198,0);

citys[144]=new Array('cz','郴州','chenzhou','chenzhou','864','hunan','湖南','','',211,0);

citys[145]=new Array('dy','德阳','deyang','deyang','265','sichuan','四川','','',48,0);

citys[146]=new Array('sx','绍兴','shaoxing','shaoxing','476','zhejiang','浙江','','',31,0);

citys[147]=new Array('ny','南阳','nanyang','nanyang','218','henan','河南','','',111,0);

citys[148]=new Array('hz','菏泽','heze','heze','147','shandong','山东','','',338,0);

citys[149]=new Array('tz','台州','taizhouzj','taizhouzj','794','zhejiang','浙江','','',35,0);

citys[150]=new Array('zy','遵义','zunyi','zunyi','370','guizhou','贵州','','',38,0);

citys[151]=new Array('fx','阜新','fuxin','fuxin','40','liaoning','辽宁','','',287,0);

citys[152]=new Array('yc','盐城','yancheng','yancheng','101','jiangsu','江苏','','',73,0);

citys[153]=new Array('xq','宿迁','suqian','suqian','88','jiangsu','江苏','','',292,0);

citys[154]=new Array('jz','焦作','jiaozuo','jiaozuo','149','henan','河南','','',106,0);

citys[155]=new Array('cz','长治','changzhi','changzhi','199','shanxi','山西','','',158,0);

citys[156]=new Array('ja','吉安','jian','jian','217','jiangxi','江西','','',221,0);

citys[157]=new Array('dz','达州','dazhou','dazhou','58','sichuan','四川','','',53,0);

citys[158]=new Array('lh','漯河','luohe','luohe','9','henan','河南','','',110,0);
...
citys[161]=new Array('hy','河源','heyuan','heyuan','192','guangdong','广东','','',268,0);

citys[162]=new Array('tl','铁岭','tieling','tieling','38','liaoning','辽宁','','',288,0);

citys[163]=new Array('jz','晋中','jinzhong','jinzhong','1176','shanxi','山西','','',161,0);

citys[164]=new Array('ak','安康','ankang','ankang','42','shanxi','陕西','','',184,0);

citys[165]=new Array('xg','孝感','xiaogan','xiaogan','26','hubei','湖北','','',327,0);

citys[166]=new Array('yy','岳阳','yueyang','yueyang','209','hunan','湖南','','',209,0);

citys[167]=new Array('zq','肇庆','zhaoqing','zhaoqing','318','guangdong','广东','','',265,0);

citys[168]=new Array('hs','衡水','hengshui','hengshui','350','hebei','河北','','',11,0);

citys[169]=new Array('mdj','牡丹江','mudanjiang','mudanjiang','251','heilongjiang','黑龙江','','',302,0);

citys[170]=new Array('aq','安庆','anqing','anqing','94','anhui','安徽','','',127,0);

citys[171]=new Array('hg','黄冈','huanggang','huanggang','67','hubei','湖北','','',328,0);

citys[172]=new Array('ld','娄底','loudi','loudi','39','hunan','湖南','','',213,0);

citys[173]=new Array('ls','乐山','leshan','leshan','1749','sichuan','四川','','',50,0);

citys[174]=new Array('sp','四平','siping','siping','63','jilin','吉林','','',86,0);

citys[175]=new Array('bb','蚌埠','bengbu','bengbu','109','anhui','安徽','','',125,0);

citys[176]=new Array('cj','昌吉','changji','changji','6','xinjiang','新疆','','',250,0);

citys[177]=new Array('sg','韶关','shaoguan','shaoguan','389','guangdong','广东','','',263,0);

citys[178]=new Array('yj','阳江','yangjiang','yangjiang','1763','guangdong','广东','','',269,0);

citys[179]=new Array('cz','潮州','chaozhou','chaozhou','432','guangdong','广东','','',271,0);

citys[180]=new Array('zjj','张家界','zhangjiajie','zhangjiajie','1370','hunan','湖南','','',334,0);

citys[181]=new Array('hh','怀化','huaihua','huaihua','90','hunan','湖南','','',336,0);

citys[182]=new Array('xsbn','西双版纳','xishuangbanna','xishuangbanna','1597','yunnan','云南','','',235,0);

citys[183]=new Array('sm','三明','sanming','sanming','93','fujian','福建','','',78,0);

citys[184]=new Array('hn','淮南','huainan','huainan','92','anhui','安徽','','',310,0);

citys[185]=new Array('yc','运城','yuncheng','yuncheng','145','shanxi','山西','','',162,0);

citys[186]=new Array('ms','眉山','meishan','meishan','255','sichuan','四川','','',279,0);

citys[187]=new Array('xc','许昌','xuchang','xuchang','61','henan','河南','','',295,0);

citys[188]=new Array('sh','绥化','suihua','suihua','55','heilongjiang','黑龙江','','',102,0);

citys[189]=new Array('fcg','防城港','fangchenggang','fangchenggang','625','guangxi','广西','','',318,0);

citys[190]=new Array('yz','永州','yongzhou','yongzhou','65','hunan','湖南','','',212,0);

citys[191]=new Array('yy','益阳','yiyang','yiyang','16','hunan','湖南','','',335,0);

citys[192]=new Array('sr','上饶','shangrao','shangrao','1031','jiangxi','江西','','',224,0);

citys[193]=new Array('qz','衢州','quzhou','quzhou','149','zhejiang','浙江','','',33,0);

citys[194]=new Array('lps','六盘水','liupanshui','liupanshui','279','guizhou','贵州','','',37,0);

citys[195]=new Array('zk','周口','zhoukou','zhoukou','45','henan','河南','','',299,0);

citys[196]=new Array('bs','白山','baishan','baishan','352','jilin','吉林','','',89,0);

citys[197]=new Array('la','六安','luan','luan','58','anhui','安徽','','',132,0);

citys[198]=new Array('tl','铜陵','tongling','tongling','42','anhui','安徽','','',312,0);

citys[199]=new Array('sz','池州','chizhou','chizhou','219','anhui','安徽','','',315,0);

citys[200]=new Array('jc','晋城','jincheng','jincheng','109','shanxi','山西','','',159,0);

citys[201]=new Array('hs','黄石','huangshi','huangshi','62','hubei','湖北','','',195,0);

citys[202]=new Array('xx','湘西','xiangxi','xiangxi','833','hunan','湖南','','',337,0);

citys[203]=new Array('yc','宜春','yichunjx','jxyichun','183','jiangxi','江西','','',222,0);

citys[204]=new Array('mm','茂名','maoming','maoming','96','guangdong','广东','','',22,0);

citys[205]=new Array('mz','梅州','meizhou','meizhou','152','guangdong','广东','','',266,0);

citys[206]=new Array('ls','凉山','liangshan','liangshan','945','sichuan','四川','','',54,0);

citys[207]=new Array('yb','宜宾','yibin','yibin','214','sichuan','四川','','',52,0);

citys[208]=new Array('hz','湖州','huzhou','huzhou','2595','zhejiang','浙江','','',30,0);

citys[209]=new Array('py','濮阳','puyang','puyang','42','henan','河南','','',294,0);

citys[210]=new Array('cz','滁州','chuzhou','chuzhou','85','anhui','安徽','','',128,0);

citys[211]=new Array('ya','延安','yanan','yanan','253','shanxi','陕西','','',181,0);

citys[212]=new Array('nj','内江','neijiang','neijiang','62','sichuan','四川','','',277,0);

citys[213]=new Array('np','南平','nanping','nanping','505','fujian','福建','','',81,0);
...
citys[216]=new Array('sy','松原','songyuan','songyuan','109','jilin','吉林','','',90,0);

citys[217]=new Array('sys','双鸭山','shuangyashan','shuangyashan','13','heilongjiang','黑龙江','','',97,0);

citys[218]=new Array('fy','阜阳','fuyang','fuyang','82','anhui','安徽','','',129,0);

citys[219]=new Array('hs','黄山','huangshan','huangshan','1761','anhui','安徽','','',313,0);

citys[220]=new Array('byne','巴彦淖尔','bayannaoer','bayannaoer','29','neimenggu','内蒙古','','',152,0);

citys[221]=new Array('wn','渭南','weinan','weinan','227','shanxi','陕西','','',180,0);

citys[222]=new Array('xn','咸宁','xianning','xianning','90','hubei','湖北','','',329,0);

citys[223]=new Array('es','恩施','enshi','enshi','1335','hubei','湖北','','',331,0);

citys[224]=new Array('fz','抚州','fuzhouj','jxfuzhou','44','jiangxi','江西','','',223,0);

citys[225]=new Array('ly','龙岩','longyan','longyan','204','fujian','福建','','',82,0);

citys[226]=new Array('th','通化','tonghua','tonghua','262','jilin','吉林','','',88,0);

citys[227]=new Array('bc','白城','baicheng','baicheng','68','jilin','吉林','','',91,0);

citys[228]=new Array('xc','宣城','xuancheng','xuancheng','305','anhui','安徽','','',316,0);

citys[229]=new Array('xlgl','锡林郭勒','xilinguole','xilinguole','301','neimenggu','内蒙古','','',321,0);

citys[230]=new Array('sy','邵阳','shaoyang','shaoyang','54','hunan','湖南','','',208,0);

citys[231]=new Array('jdz','景德镇','jingdezhen','jingdezhen','417','jiangxi','江西','','',215,0);

citys[232]=new Array('qj','曲靖','qujing','qujing','108','yunnan','云南','','',226,0);

citys[233]=new Array('jy','揭阳','jieyang','jieyang','36','guangdong','广东','','',272,0);

citys[234]=new Array('gy','广元','guangyuan','guangyuan','116','sichuan','四川','','',275,0);

citys[235]=new Array('bz','巴中','bazhong','bazhong','34','sichuan','四川','','',281,0);

citys[236]=new Array('jy','济源','jiyuan','jiyuan','25','henan','河南','','',112,0);

citys[237]=new Array('hg','鹤岗','hegang','hegang','10','heilongjiang','黑龙江','','',96,0);
...
citys[240]=new Array('ts','天水','tianshui','tianshui','99','gansu','甘肃','','',169,0);

citys[241]=new Array('yl','榆林','sxyulin','sxyulin','26','shanxi','陕西','','',183,0);

citys[242]=new Array('px','萍乡','pingxiang','pingxiang','121','jiangxi','江西','','',216,0);

citys[243]=new Array('hm','哈密','hami','hami','8','xinjiang','新疆','','',244,0);

citys[244]=new Array('yf','云浮','yunfu','yunfu','19','guangdong','广东','','',273,0);

citys[245]=new Array('zg','自贡','zigong','zigong','161','sichuan','四川','','',46,0);

citys[246]=new Array('ab','阿坝','aba','aba','260','sichuan','四川','','',283,0);

citys[247]=new Array('nd','宁德','ningde','ningde','549','fujian','福建','','',83,0);

citys[248]=new Array('mas','马鞍山','maanshan','maanshan','35','anhui','安徽','','',126,0);

citys[249]=new Array('als','阿拉善','alashan','alashan','554','neimenggu','内蒙古','','',322,0);
...
citys[254]=new Array('qxn','黔西南','qianxinan','qianxinan','270','guizhou','贵州','','',42,0);

citys[255]=new Array('jx','鸡西','jixi','jixi','97','heilongjiang','黑龙江','','',95,0);

citys[256]=new Array('yc','伊春','hljyichun','hljyichun','260','heilongjiang','黑龙江','','',99,0);

citys[257]=new Array('dxal','大兴安岭','daxinganling','daxinganling','52','heilongjiang','黑龙江','','',303,0);

citys[258]=new Array('xz','宿州','suzhouah','ahsuzhou','92','anhui','安徽','','',130,0);

citys[259]=new Array('wz','梧州','wuzhou','wuzhou','84','guangxi','广西','','',135,0);

citys[260]=new Array('gg','贵港','guigang','guigang','24','guangxi','广西','','',137,0);
...
citys[263]=new Array('ez','鄂州','ezhou','ezhou','42','hubei','湖北','','',201,0);

citys[264]=new Array('aks','阿克苏','akesu','akesu','11','xinjiang','新疆','','',246,0);

citys[265]=new Array('sw','汕尾','shanwei','shanwei','373','guangdong','广东','','',267,0);
...
citys[269]=new Array('qdn','黔东南','qiandongnan','qiandongnan','698','guizhou','贵州','','',43,0);
...
citys[273]=new Array('zy','张掖','zhangye','zhangye','244','gansu','甘肃','','',171,0);

citys[274]=new Array('jq','酒泉','jiuquan','jiuquan','452','gansu','甘肃','','',173,0);

citys[275]=new Array('ln','陇南','longnan','longnan','29','gansu','甘肃','','',324,0);
...
citys[281]=new Array('ya','雅安','yaan','yaan','289','sichuan','四川','','',280,0);

citys[282]=new Array('gz','甘孜','ganzi','ganzi','590','sichuan','四川','','',284,0);

citys[283]=new Array('ls','丽水','lishui','lishui','713','zhejiang','浙江','','',285,0);

citys[284]=new Array('bz','亳州','bozhou','bozhou','48','anhui','安徽','','',314,0);

citys[285]=new Array('bs','百色','baise','baise','46','guangxi','广西','','',139,0);

citys[286]=new Array('hz','贺州','hezhou','hezhou','142','guangxi','广西','','',319,0);

citys[287]=new Array('wlcb','乌兰察布','wulanchabu','wulanchabu','77','neimenggu','内蒙古','','',153,0);

citys[288]=new Array('zw','中卫','zhongwei','zhongwei','124','ningxia','宁夏','','',342,0);

citys[289]=new Array('jc','金昌','jinchang','jinchang','4','gansu','甘肃','','',167,0);
...
citys[297]=new Array('bygl','巴音郭楞','bayinguoleng','bayinguoleng','40','xinjiang','新疆','','',249,0);

citys[298]=new Array('lz','林芝','linzhi','linzhi','94','xicang','西藏','','',262,0);

citys[299]=new Array('tr','铜仁','tongren','tongren','111','guizhou','贵州','','',40,0);

citys[300]=new Array('lb','来宾','laibin','laibin','19','guangxi','广西','','',141,0);

citys[301]=new Array('cz','崇左','chongzuo','chongzuo','12','guangxi','广西','','',320,0);

citys[302]=new Array('xz','忻州','xinzhou','xinzhou','116','shanxi','山西','','',163,0);

citys[303]=new Array('wz','吴忠','wuzhong','wuzhong','16','ningxia','宁夏','','',340,0);

citys[304]=new Array('gy','固原','guyuan','guyuan','8','ningxia','宁夏','','',341,0);

citys[305]=new Array('ww','武威','wuwei','wuwei','14','gansu','甘肃','','',170,0);

citys[306]=new Array('gn','甘南','gannan','gannan','15','gansu','甘肃','','',326,0);

citys[307]=new Array('hx','海西','haixi','haixi','251','qinghai','青海','','',193,0);

citys[308]=new Array('jm','荆门','jingmen','jingmen','26','hubei','湖北','','',200,0);

citys[309]=new Array('yx','玉溪','yuxi','yuxi','388','yunnan','云南','','',227,0);

citys[310]=new Array('hh','红河','honghe','honghe','340','yunnan','云南','','',234,0);

citys[311]=new Array('dh','德宏','dehong','dehong','40','yunnan','云南','','',238,0);
...
citys[315]=new Array('qn','黔南','qiannan','qiannan','271','guizhou','贵州','','',44,0);

citys[316]=new Array('hb','鹤壁','hebi','hebi','30','henan','河南','','',107,0);

citys[317]=new Array('wzs','五指山','wuzhishan','wuzhishan','30','hainan','海南','','',353,0);

citys[318]=new Array('xa','兴安','xingan','xingan','193','neimenggu','内蒙古','','',154,0);

citys[319]=new Array('jyg','嘉峪关','jiayuguan','jiayuguan','145','gansu','甘肃','','',343,0);
...
citys[323]=new Array('hb','海北','haibei','haibei','186','qinghai','青海','','',188,0);

citys[324]=new Array('xt','仙桃','xiantao','xiantao','1','hubei','湖北','','',202,0);

citys[325]=new Array('sz','随州','suizhou','suizhou','11','hubei','湖北','','',330,0);

citys[326]=new Array('bs','保山','baoshan','baoshan','419','yunnan','云南','','',228,0);
...
citys[330]=new Array('ws','文山','wenshan','wenshan','148','yunnan','云南','','',233,0);
...
citys[336]=new Array('wc','文昌','wenchang','wc','307','hainan','海南','','',397,0);

citys[337]=new Array('qh','琼海','qionghai','qionghai','400','hainan','海南','','',399,0);

citys[338]=new Array('dz','儋州','danzhou','danzhou','229','hainan','海南','','',400,0);

citys[339]=new Array('wn','万宁','wanning','wanning','496','hainan','海南','','',401,0);
...
citys[343]=new Array('cm','澄迈','chengmai','chengmai','146','hainan','海南','','',405,0);
...
citys[348]=new Array('ls','陵水','lingshui','lingshui','500','hainan','海南','','',410,0);

citys[349]=new Array('bt','保亭','baoting','baoting','27','hainan','海南','','',411,0);
...
abroadcitys[136]=new Array('ald','奥兰多','aolanduo','orlando','14','','佛罗里达','','',2338,1,'-05:00');
...
abroadcitys[207]=new Array('ndl','南都留','nanduliu','minamitsuru','11','shanli','山梨','','',2921,1,'+09:00');
...
// remotejs start from https://player.youku.com/jsapi 08-28 18:43:40 
/**
 * dispatch 
 * dispatch 2019-02-25
 * for phone
