...
var XZWebUrlWriter = {
    ...
    getRequest: function (url, type) {
        ...
        $.ajax({
            ...
            beforeSend: function (XHR) {
                XHR.setRequestHeader('xSRF-Token', $('#xz_srf_token').val());
            },
    ...
    getWebIm_ServerUrl: function () {
        return window.location.protocol + '//' + domain + '/webimRequest/getServerUrl';
    },
    getWebIm_DrawIframeUrl: function (userid) {
        return window.location.protocol + '//' + domain + '/webimRequest/drawIframe?userid=' + userid;
    },
    getWebIm_DrawBaseBtnUrl: function (next) {
        return window.location.protocol + '//' + domain + '/webimRequest/drawImBaseBtn?next=' + next;
    },
    getWebIm_DrawZhunaIframeUrl: function () {
        return window.location.protocol + '//' + domain + '/webimRequest/drawZhunaIframe';
    },
    getWebIm_IframeUrl: function (userId) {
        return webimIframUrl;
    },
    getWebIm_LodgeUnitData: function (roomid) {
        return window.location.protocol + '//' + domain + '/webimRequest/getLodgeUnitData?roomid=' + roomid;
    },
    getWebIm_FavoriteList: function (userid) {
        return window.location.protocol + '//' + domain + '/webimRequest/getFavoriteList?userid=' + userid;
    },
    getWebIm_FavoriteGroupDetail: function (groupId) {
        return window.location.protocol + '//' + domain + '/webimRequest/getFavoriteGroupDetail?groupId=' + groupId;
    },
    getWebIm_RequestNotificationUrl: function (userid) {
        return window.location.protocol + '//' + domain + '/webimRequest/getNotification?terminal=all_web&userid=' + userid;
    },
    getWebIm_RequestUserSysNoticeCnt: function (userid, userrole) {
        return window.location.protocol + '//' + domain + '/webimRequest/getUserSysNoticeCnt?userid=' + userid + '&userrole=' + userrole;
    },
    getWebIm_RequestUserSysNotice: function (userid, userrole) {
        return window.location.protocol + '//' + domain + '/webimRequest/getUserSysNotice?userid=' + userid + '&userrole=' + userrole;
    },
    getWebIm_UserData: function (userid) {
        return window.location.protocol + '//' + domain + '/webimRequest/getUserData?userid=' + userid;
    },
    getWebIm_talkHis: function (isTenant, offset, length) {
        return window.location.protocol + '//' + doamin + '/webimRequest/loadTalkHis?isTenant=' + isTenant + '&offset=' + offset + '&length=' + length + '&userId=' + currentUser;
    },
    getWebIm_talkMagHis: function (tenantId, luId, length, lastMessageId) {
        return window.location.protocol + '//' + domain + '/webimRequest/loadTalkMsgHis?tenantId= ' + tenantId + '&luId=' + luId + '&length=' + length + '&lastMessageId= ' + lastMessageId;
    },
    getWebIm_TalkHisUrl: function (landlordid, tenantid, objid, userid) {
        return window.location.protocol + '//' + domain + '/webimRequest/getTalkHisUrl?landlordid=' + landlordid + '&tenantid=' + tenantid + '&objid=' + objid + '&userid=' + userid + '&_t=' + new Date().getTime();
    },
    ...
    getWebIm_RequestUserStateUrl: function (userid, imuserrole) {
        return window.location.protocol + '//' + domain + '/webimRequest/getUserState?userid=' + userid + '&imuserrole=' + imuserrole;
    },
    getWebIm_RequestSynTalkMsgUrl: function (userid, synMinTime, synMaxTime) {
        return window.location.protocol + '//' + domain + '/webimRequest/SynTalkMsg?userId=' + userid + '&synMinTime=' + synMinTime + '&synMaxTime=' + synMaxTime;
    },
    getWebIm_RequestTalkMsgSetRead: function (tenantId, luId, isTenant) {
        return window.location.protocol + '//' + domain + '/webimRequest/talkMsgSetRead?tenantId=' + tenantId + '&luId=' + luId + '&isTenant=' + isTenant + '&_t=' + new Date().getTime();
    },
    ...
    getWebIm_AlipayTrustLayer: function (landlordid) {
        return window.location.protocol + '//' + domain + '/webimRequest/getAlipayTrustLayer?landlordid=' + landlordid + '&_t=' + new Date().getTime();
    },
    ...
    getWebIm_AllFriendAndLuData: function (allfriendid, allluid) {
        return window.location.protocol + '//' + domain + '/webimRequest/getAllFriendAndLuData';
    ...
    getOperateScreen: function (toUserId, operate) {
        return window.location.protocol + '//' + domain + '/webimRequest/doOperateImScreen?toUserId=' + toUserId + '&operate=' + operate + '&_t=' + new Date().getTime();
    },
    checkIsInScreenList: function (toUserId) {
        return window.location.protocol + '//' + domain + '/webimRequest/checkIsInScreenList?toUserId=' + toUserId + '&_t=' + new Date().getTime();
    },
    getLodgeUnitState: function (luId) {
        return window.location.protocol + '//' + domain + '/webimRequest/getLodgeUnitState?luId=' + luId + '&_t=' + new Date().getTime();
    },
    ...
    getFangDong_SetWechatPaymentUrl: function (id, ownerId) {
        return window.location.protocol + '//' + domain + '/xzweb.php?op=FangDong_SetWechatPayment&id=' + id + '&ownerid=' + ownerId;
    },
    ...
    */
    ...
    config: {
        ...
        //搜索
        searchDomainDev: 'https://test-wirelesspub-search-env111.xiaozhu.com',
        searchDomainTest: 'https://' + document.domain.replace("xzweb", 'wirelesspub-search'),
        searchDomainPrerelease: 'https://prerelease-wirelesspub-search.xiaozhu.com',
        searchDomainPro: 'https://wirelesspub-search.xiaozhu.com'
    },
    // 获取安全验证方式
    ...
    getSearchSuggestList: function (keyword) {  // 首页搜索建议
        return this.config['searchDomain' + this.config.env()] + '/search/webSuggestionCity';
    },
    getSearchResultSuggestList: function (keyword) {  // 结果页关键字搜索建议
        return this.config['searchDomain' + this.config.env()] + '/search/webSuggestionLandmark';
    },
    ...
    getLandlordRealNameState: function (flashbook, luId) {
        if (!luId) {
    ...
    getWeChatCode: function () {
        return window.location.protocol + '//' + domain + '/ajax.php?op=Ajax_GetQrcode_FangDongAccount';
    },
    getWeChatBack: function (balanceForm, realName, identifyId, id) {
        return window.location.protocol + '//' + domain + '/ajax.php?op=AJAX_SetWeChatInfo&balanceForm=' + balanceForm + '&realName=' + realName + '&identifyId=' + identifyId + '&id=' + id;
    },
    setFlashbookStatus: function () {
        return window.location.protocol + '//' + lodgeUnitCenterDomain + '/app/xzfd/web/500/flashbook/updateSetting'
    }
}

var xzRegularExpression = {
    a: 1,
    isNum: /^\d{1,}$/,
    isMobile: /^\d{11}$/,
    isMobileWithSplit: /^[\d-]{10,}$/,
    isUsername: /^[\w|\u4E00-\u9FA5|\u3400-\u4DB5|\uE815-\uE864|\u9FA6-\u9FBB]*$/,
    isChinese: /^[\u4E00-\u9FA5|\u3400-\u4DB5|\uE815-\uE864|\u9FA6-\u9FBB]+$/,
    simpleMobile: /^\d{11}$/,
    mobile: /^1((2[7])|(3[0-9])|(4[5-9])|(5[0-9])|(6[124567])|(7[0-8])|(8[0-9])|(9[0-9]))\d{8}$/,
    password: /^(?![a-zA-Z]+$)(?![A-Z0-9]+$)(?![A-Z\W*!@.\-? : ;|$#%^&()_+=\[\]\\\/{}<>",~`']+$)(?![a-z0-9]+$)(?![a-z\W*!@.\-? : ;|$#%^&()_+=\[\]\\\/{}<>",~`']+$)(?![0-9\W*!@.\-? : ;|$#%^&()_+=\[\]\\\/{}<>",~`']+$)[a-zA-Z0-9\W_!@#$%^&*`~()-+=]{8,16}$/,
    numbers: /[1-9][0-9]{4}/,
    simpleEmail: /^.*?@.+$/,
    email: /^[a-zA-Z0-9_\.\-]+@[a-zA-Z0-9_\-]+(\.[a-zA-Z0-9_\-]+)+[a-zA-Z]+$/,
    passport: /^[\d\w]{4,20}$/,
    inviteCode: /^[A-Z0-9]{7,15}$/,
    simpleDate: /^([0-9]{4})-([0-9]{2})-([0-9]{2})$/,
    simpleDateTime: /^[1-2][0-9]{3}-[0-1][0-9]-[0-3][0-9] [0-2][0-9](:[0-5][0-9]){1,2}$/,
    isRealName: /^[\u4E00-\u9FFF\u3400-\u4DBF\uF900-\uFAFF]+(·[\u4E00-\u9FFF\u3400-\u4DBF\uF900-\uFAFF]+|•[\u4E00-\u9FFF\u3400-\u4DBF\uF900-\uFAFF]+)*$/,
    isRealNameForeign: /^[^\～！@#¥%……&*（）——\+\-\=「」|【】、：“；‘《》？，。/~`\!\$\^\(\)_\{\}\|\[\]\:";'<>\?,\.\/]{1,50}$/
};
window.captchaModel = {
...
function searchCity(pageType)  //首页搜索部分回调这个方法,其他地方还没有看到
{
    ...
    if (searchPutKey == _keywordValue || searchPutKey == '输入地点...')
        searchPutKey = '';
    console.log('cityDomain', cityDomain)
    if (!searchCity || searchCity == '城市或目的地' || searchCity == '城市' || !cityDomain) {
        if (abroad == 1) {
    ...
    if (searchCity.match(re) != null) {
        ...
        if ($("#landmarktype").val() == 'city') { //如果是城市则跳转到城市页面只携带domain和入离日期
            searchPutKey = '';
            searchKey = ''
        }
        ...
        if (startDate != '' || endDate != '')
            paramStr = paramArray.join('&');
        if (paramStr != '') {
            if (searchLid && searchLid !== "undifined") {
                if (searchKey)
            ...
            } else if ((searchLid && searchLid !== 'undefined') && (searchPutKey || searchKey)) {
                if (searchKey)
    ...
    calendarV2.prototype.gengerateCalArray = function () {
        ...
        for (var i = 0; i <= this.totalMohth; i++) {
            ...
            for (var j = 1; j <= 37; j++) {
                ...
                this.dateArray.push({
                    y: this.setDay.getFullYear(),
                    m: this.setDay.getMonth(),
                    d: this.setDay.getDate(),
                    w: this.setDay.getDay()
                });
            }
            ;
        }
    ...
    $.suggest = function (input, options, reset) {
        ...
        function suggest() {
            ...
            if (q != '' && q != defaultCity && q != defaultAbroadCity) {
                ...
                indexSearchTime = new Date().getTime();
                var inputTimer = setTimeout(function () {
                    let timeNum = new Date().getTime();
                    if (timeNum - indexSearchTime >= 300) {
        ...
        function displayItems(items) {
            ...
            if (items != '') {
                if ($('#actionname').val() == 'Front_Search' || $('#actionname').val() == 'Front_Search_Partner') {
                    searchInputVal = $("#searchcityd").val();
                } else {
                    searchInputVal = $("#searchcity").val();
                }
                searchAbout.getSuggestionHtml(searchInputVal, function callback(data) { //获取搜索结果callback
                    var searchIndexRes = data.content || {};
                    $('#suggestion_citydomain').attr('value', '');
                    var searchResHtml = '';
                    if ((searchIndexRes.city && searchIndexRes.city.length == 0) && (searchIndexRes.landmarkAndDistrict && searchIndexRes.landmarkAndDistrict.length == 0) && (searchIndexRes.baiduLandmark && searchIndexRes.baiduLandmark.length == 0)) {
                        searchResHtml = '<div class="ac_result_tip overfllow-esllipse">' + '未找到与<em class="high_light " style="color:#FF5F7A" >' + searchInputVal + '</em>相关的结果，建议修改关键字重试</div>';
                    } else {
                        searchResHtml = searchAbout.transFormSearchRes(searchIndexRes)
                    }
                    htmlResult(searchResHtml, items);
                });  // 发送请求，获取搜索结果
            } else {
                html = '';
                $results.hide();
                htmlResult(html, items);
            }
        }

        function htmlResult(html, items) {
        ...
        function selectCurrentResult() { // 点击选择搜索结果

            $currentResult = getCurrentResult();
            if ($currentResult) {

                var showWord = $currentResult.children('.name').attr('cur__val')
                $input.val(showWord)
                $results.hide();
                ...
                if (typeof ($.fn.autopoint) == "function") {
                    $("#keyword,#keyword_icon").autopoint({
                        url: window.location.protocol + '//' + domain + '/ajaxRequest/Ajax_getLandMarkSuggestion',
                        submit: ["searchbtn"]
                    });
                }
                if (options.onSelect) {
                ...
                city_name = $input.val();
                $('#searchcity').blur();
                var selectedCityDomain = $currentResult.attr('rel');
                var landmarkid = $currentResult.attr('landmarkid');
                var landmarktype = $currentResult.attr('landmarktype');
                var isAbroad = $currentResult.attr('isAbroad');
                var timeZone = $currentResult.attr('timeZone');
                new execCalendar('#startenddate', {
                    abroad: (isAbroad && isAbroad == "true") ? true : false,
                    cityName: showWord,
                    timeZone: timeZone
                });

                $('#isAbroad').val(isAbroad);
                $('#suggestion_citydomain').val(selectedCityDomain);
                $('#cityDomain').val(selectedCityDomain);
                if (landmarktype != 'city') { // 只有非城市的关键字才需要带到结果页
                    $('#keyword').val(city_name);
                    $('#searchkey').val(city_name);
                } else {
                    $('#keyword').val('');
                    $('#searchkey').val('');
                }
                if (landmarkid == '' || !isDefined(landmarkid) || landmarkid == 'undefined') {
                    $('#landmarkid').val('');
                    $('#landmarktype').val('');
                    $('#defaulturl').val('');
                } else {
        ...
        function nextResult() {
            ...
            searchInputVal = $("#searchcity").val();
            $("#searchcity").val('').val(searchInputVal);
            if ($currentResult)
                $currentResult
...
function returnHotCityList(initial) {
    ...
    var nowHotCity = overseasOrInland == 0 ? ajaxAllCitys.internalHotCity : ajaxAllCitys.abroadHotCity
...
var searchAbout = {
    showHighLightCity: function (searchResult) { // 关键字高亮展示
        const searchVal = this.searchVal;
        var showName = searchResult.shortName || searchResult.name;
        if (showName) {
            return showName.replace(new RegExp(searchInputVal), `<em class="high_light" style="color:#FF5F7A" curValue=${showName}>${searchInputVal}</em>`);
        }
    },
    getSuggestionHtml: function (keyword, callback) {  //获取关键字搜索结果
        // XZWebAjax.get(XZWebUrlWriter.getSearchSuggestList(), {'keyword':keyword}, true, function(data){
        //   callback && callback(data);
        // },'json');
    },
    transFormSearchRes: function (resData) { // 转换搜索结果格式
        var listArr = [(resData.city || []), (resData.landmarkAndDistrict || []), (resData.baiduLandmark || [])],
            listHtml = '';
        for (var j = 0; j < listArr.length; j++) {
            for (var i = 0; i < listArr[j].length; i++) {
                var desSpan = ''
                if (j == 0) { //城市 外国的要展示国家，国内的展示省 直辖市/港澳台不展示省
                    if (listArr[j][i].isAbroad) {
                        desSpan = '<span class="des">' + listArr[j][i].nationName + '</span>';
                    } else {
                        desSpan = '<span class="des">' + ((listArr[j][i].isMunicipal || listArr[j][i].isGangAo) ? '' : listArr[j][i].provinceName) + '</span>';
                    }
                } else { //行政区、地标店 外国的要展示市、国家，国内的展示市、省
                    desSpan = listArr[j][i].isAbroad ?
                        '<span class="des" type=landGroup' + j + '>' +
                        listArr[j][i].cityName +
                        '·' + listArr[j][i].nationName +
                        '</span>' :
                        '<span class="des">' +
                        ((listArr[j][i].isMunicipal || listArr[j][i].isGangAo) ? "" : ((listArr[j][i].provinceName) + '·')) +
                        listArr[j][i].cityName +
                        '</span>';
                }
                listHtml += '<li class="suggest-li" rel=' + listArr[j][i].domain + ' landmarktype=' + (j == 0 ? 'city' : 'landmark') + ' landmarkid=' + (j == 0 ? "undefined" : listArr[j][i].id) + ' isAbroad=' + listArr[j][i].isAbroad + ' timeZone=' + listArr[j][i].timezone + '>' +

                    '<span class="name" cur__val=' + (listArr[j][i].shortName || listArr[j][i].name) + '>' + searchAbout.showHighLightCity(listArr[j][i]) + '</span>' +
                    desSpan +
                    '<span class="type">' + listArr[j][i].landmarkDesc || '' + '</span>' +
                    '</li>'
            }
        }
        return ('<ul class="suggest-ul">' + listHtml + '</ul>')
    }
}
...
hotcitys[0] = new Array('bj', '北京', 'beijing', 'bj', '15835', 'beijing', '北京', '', '', 12, 0);

hotcitys[1] = new Array('sh', '上海', 'shanghai', 'sh', '16127', 'shanghai', '上海', '', '', 13, 0);

hotcitys[3] = new Array('gz', '广州', 'guangzhou', 'gz', '10748', 'guangdong', '广东', '', '', 16, 0);

hotcitys[2] = new Array('cd', '成都', 'chengdu', 'cd', '15496', 'sichuan', '四川', '', '', 45, 0);

hotcitys[4] = new Array('sz', '深圳', 'shenzhen', 'sz', '7385', 'guangdong', '广东', '', '', 17, 0);

hotcitys[8] = new Array('xa', '西安', 'xian', 'xa', '12347', 'shanxi', '陕西', '', '', 176, 0);

hotcitys[15] = new Array('nj', '南京', 'nanjing', 'nj', '5749', 'jiangsu', '江苏', '', '', 65, 0);

hotcitys[9] = new Array('hz', '杭州', 'hangzhou', 'hz', '7956', 'zhejiang', '浙江', '', '', 26, 0);

hotcitys[7] = new Array('cq', '重庆', 'chongqing', 'cq', '13067', 'chongqing', '重庆', '', '', 15, 0);

hotcitys[12] = new Array('wh', '武汉', 'wuhan', 'wh', '7917', 'hubei', '湖北', '', '', 194, 0);

hotcitys[16] = new Array('sz', '苏州', 'suzhou', 'su', '5609', 'jiangsu', '江苏', '', '', 67, 0);

hotcitys[18] = new Array('qd', '青岛', 'qingdao', 'qd', '12084', 'shandong', '山东', '', '', 114, 0);

hotcitys[11] = new Array('xm', '厦门', 'xiamen', 'xm', '5793', 'fujian', '福建', '', '', 76, 0);

hotcitys[6] = new Array('sy', '三亚', 'sanya', 'sanya', '7498', 'hainan', '海南', '', '', 144, 0);

hotcitys[10] = new Array('heb', '哈尔滨', 'haerbin', 'hrb', '4113', 'heilongjiang', '黑龙江', '', '', 93, 0);

hotcitys[14] = new Array('tj', '天津', 'tianjin', 'tj', '3911', 'tianjin', '天津', '', '', 14, 0);

hotcitys[17] = new Array('km', '昆明', 'kunming', 'km', '3829', 'yunnan', '云南', '', '', 225, 0);

hotcitys[5] = new Array('xg', '香港', 'xianggang', 'hongkong', '465', 'xianggang', '香港', '', '', 344, 0);

hotcitys[13] = new Array('cs', '长沙', 'changsha', 'cs', '5448', 'hunan', '湖南', '', '', 204, 0);

var abroadhotcitys = new Array();

abroadhotcitys[0] = new Array('Tokyo', '东京', 'dongjing', 'Tokyo', '0', '', '', '', '', 1190, '1', '+09:00');

abroadhotcitys[1] = new Array('Osaka', '大阪', 'daban', 'Osaka', '0', '', '', '', '', 1191, '1', '+09:00');

abroadhotcitys[2] = new Array('Kyoto', '京都', 'jingdu', 'Kyoto', '0', '', '', '', '', 1196, '1', '+09:00');
...
citys[0] = new Array('bj', '北京', 'beijing', 'bj', '15835', 'beijing', '北京', '', '', 12, 0);

citys[1] = new Array('sh', '上海', 'shanghai', 'sh', '16127', 'shanghai', '上海', '', '', 13, 0);

citys[2] = new Array('gz', '广州', 'guangzhou', 'gz', '10748', 'guangdong', '广东', '', '', 16, 0);

citys[3] = new Array('cd', '成都', 'chengdu', 'cd', '15496', 'sichuan', '四川', '', '', 45, 0);

citys[4] = new Array('sz', '深圳', 'shenzhen', 'sz', '7385', 'guangdong', '广东', '', '', 17, 0);

citys[5] = new Array('xa', '西安', 'xian', 'xa', '12347', 'shanxi', '陕西', '', '', 176, 0);

citys[6] = new Array('nj', '南京', 'nanjing', 'nj', '5749', 'jiangsu', '江苏', '', '', 65, 0);

citys[7] = new Array('hz', '杭州', 'hangzhou', 'hz', '7956', 'zhejiang', '浙江', '', '', 26, 0);

citys[8] = new Array('cq', '重庆', 'chongqing', 'cq', '13067', 'chongqing', '重庆', '', '', 15, 0);

citys[9] = new Array('wh', '武汉', 'wuhan', 'wh', '7917', 'hubei', '湖北', '', '', 194, 0);

citys[10] = new Array('sz', '苏州', 'suzhou', 'su', '5609', 'jiangsu', '江苏', '', '', 67, 0);

citys[11] = new Array('wx', '无锡', 'wuxi', 'wx', '1900', 'jiangsu', '江苏', '', '', 66, 0);

citys[12] = new Array('qd', '青岛', 'qingdao', 'qd', '12084', 'shandong', '山东', '', '', 114, 0);

citys[13] = new Array('xm', '厦门', 'xiamen', 'xm', '5793', 'fujian', '福建', '', '', 76, 0);

citys[14] = new Array('sy', '三亚', 'sanya', 'sanya', '7498', 'hainan', '海南', '', '', 144, 0);

citys[15] = new Array('dl', '大连', 'dalian', 'dl', '4543', 'liaoning', '辽宁', '', '', 56, 0);

citys[16] = new Array('heb', '哈尔滨', 'haerbin', 'hrb', '4113', 'heilongjiang', '黑龙江', '', '', 93, 0);

citys[17] = new Array('qhd', '秦皇岛', 'qinhuangdao', 'qinhuangdao', '7089', 'hebei', '河北', '', '', 3, 0);

citys[18] = new Array('tj', '天津', 'tianjin', 'tj', '3911', 'tianjin', '天津', '', '', 14, 0);

citys[19] = new Array('km', '昆明', 'kunming', 'km', '3829', 'yunnan', '云南', '', '', 225, 0);

citys[20] = new Array('xg', '香港', 'xianggang', 'hongkong', '465', 'xianggang', '香港', '', '', 344, 0);

citys[21] = new Array('cc', '长春', 'changchun', 'cc', '1755', 'jilin', '吉林', '', '', 84, 0);

citys[22] = new Array('sy', '沈阳', 'shenyang', 'sy', '3277', 'liaoning', '辽宁', '', '', 55, 0);

citys[23] = new Array('hf', '合肥', 'hefei', 'hf', '1602', 'anhui', '安徽', '', '', 123, 0);

citys[24] = new Array('zz', '郑州', 'zhengzhou', 'zz', '2764', 'henan', '河南', '', '', 103, 0);

citys[25] = new Array('ty', '太原', 'taiyuan', 'ty', '1743', 'shanxi', '山西', '', '', 155, 0);

citys[26] = new Array('wh', '威海', 'weihai', 'wei', '4218', 'shandong', '山东', '', '', 120, 0);

citys[27] = new Array('lj', '丽江', 'lijiang', 'lijiang', '2910', 'yunnan', '云南', '', '', 230, 0);

citys[28] = new Array('dl', '大理', 'dali', 'dali', '4663', 'yunnan', '云南', '', '', 237, 0);

citys[29] = new Array('gl', '桂林', 'guilin', 'gl', '2714', 'guangxi', '广西', '', '', 134, 0);

citys[30] = new Array('am', '澳门', 'aomen', 'macao', '264', 'aomen', '澳门', '', '', 345, 0);

citys[31] = new Array('fz', '福州', 'fuzhou', 'fz', '1611', 'fujian', '福建', '', '', 75, 0);

citys[32] = new Array('nb', '宁波', 'ningbo', 'nb', '2196', 'zhejiang', '浙江', '', '', 27, 0);

citys[33] = new Array('zh', '珠海', 'zhuhai', 'zhuhai', '1734', 'guangdong', '广东', '', '', 18, 0);

citys[34] = new Array('cs', '长沙', 'changsha', 'cs', '5448', 'hunan', '湖南', '', '', 204, 0);

citys[35] = new Array('sjz', '石家庄', 'shijiazhuang', 'sjz', '1990', 'hebei', '河北', '', '', 1, 0);

citys[36] = new Array('ls', '拉萨', 'lasa', 'ls', '315', 'xicang', '西藏', '', '', 256, 0);

citys[37] = new Array('cz', '常州', 'changzhou', 'changzhou', '834', 'jiangsu', '江苏', '', '', 69, 0);

citys[38] = new Array('yz', '扬州', 'yangzhou', 'yangzhou', '1212', 'jiangsu', '江苏', '', '', 74, 0);

citys[39] = new Array('dg', '东莞', 'dongguan', 'dg', '754', 'guangdong', '广东', '', '', 24, 0);

citys[40] = new Array('hk', '海口', 'haikou', 'hn', '1828', 'hainan', '海南', '', '', 143, 0);

citys[41] = new Array('lz', '兰州', 'lanzhou', 'lz', '1401', 'gansu', '甘肃', '', '', 166, 0);

citys[42] = new Array('ly', '洛阳', 'luoyang', 'luoyang', '1341', 'henan', '河南', '', '', 104, 0);

citys[43] = new Array('wlmq', '乌鲁木齐', 'wulumuqi', 'xj', '298', 'xinjiang', '新疆', '', '', 241, 0);

citys[44] = new Array('xz', '徐州', 'xuzhou', 'xuzhou', '697', 'jiangsu', '江苏', '', '', 68, 0);

citys[45] = new Array('gy', '贵阳', 'guiyang', 'gy', '2122', 'guizhou', '贵州', '', '', 36, 0);

citys[46] = new Array('hhht', '呼和浩特', 'huhehaote', 'nmg', '803', 'neimenggu', '内蒙古', '', '', 145, 0);

citys[47] = new Array('jn', '济南', 'jinan', 'jn', '1994', 'shandong', '山东', '', '', 113, 0);

citys[48] = new Array('ts', '唐山', 'tangshan', 'tangshan', '1139', 'hebei', '河北', '', '', 2, 0);

citys[49] = new Array('bd', '保定', 'baoding', 'baoding', '1096', 'hebei', '河北', '', '', 6, 0);

citys[50] = new Array('nc', '南昌', 'nanchang', 'nc', '1359', 'jiangxi', '江西', '', '', 214, 0);

citys[51] = new Array('hd', '邯郸', 'handan', 'handan', '295', 'hebei', '河北', '', '', 4, 0);

citys[52] = new Array('nn', '南宁', 'nanning', 'nn', '1779', 'guangxi', '广西', '', '', 142, 0);

citys[53] = new Array('wf', '潍坊', 'weifang', 'weifang', '557', 'shandong', '山东', '', '', 119, 0);

citys[54] = new Array('jz', '锦州', 'jinzhou', 'jinzhou', '466', 'liaoning', '辽宁', '', '', 60, 0);

citys[55] = new Array('rz', '日照', 'rizhao', 'rizhao', '2026', 'shandong', '山东', '', '', 306, 0);

citys[56] = new Array('ly', '临沂', 'linyi', 'linyi', '371', 'shandong', '山东', '', '', 307, 0);

citys[57] = new Array('as', '鞍山', 'anshan', 'anshan', '132', 'liaoning', '辽宁', '', '', 57, 0);

citys[58] = new Array('lf', '廊坊', 'langfang', 'langfang', '906', 'hebei', '河北', '', '', 10, 0);

citys[59] = new Array('dq', '大庆', 'daqing', 'daqing', '284', 'heilongjiang', '黑龙江', '', '', 98, 0);

citys[60] = new Array('bh', '北海', 'beihai', 'beihai', '4312', 'guangxi', '广西', '', '', 317, 0);

citys[61] = new Array('zs', '中山', 'zhongshan', 'zhongshan', '444', 'guangdong', '广东', '', '', 25, 0);

citys[62] = new Array('xn', '西宁', 'xining', 'xn', '1144', 'qinghai', '青海', '', '', 186, 0);

citys[63] = new Array('jh', '金华', 'jinhua', 'jinhua', '868', 'zhejiang', '浙江', '', '', 32, 0);

citys[64] = new Array('dd', '丹东', 'dandong', 'dandong', '1175', 'liaoning', '辽宁', '', '', 59, 0);

citys[65] = new Array('cd', '承德', 'chengde', 'chengde', '2615', 'hebei', '河北', '', '', 8, 0);

citys[66] = new Array('pj', '盘锦', 'panjin', 'panjin', '394', 'liaoning', '辽宁', '', '', 63, 0);

citys[67] = new Array('zb', '淄博', 'zibo', 'zibo', '329', 'shandong', '山东', '', '', 115, 0);

citys[68] = new Array('zz', '株洲', 'zhuzhou', 'zhuzhou', '310', 'hunan', '湖南', '', '', 205, 0);

citys[69] = new Array('fs', '佛山', 'foshan', 'foshan', '1417', 'guangdong', '广东', '', '', 20, 0);

citys[70] = new Array('jl', '吉林', 'jilinshi', 'jilin', '564', 'jilin', '吉林', '', '', 85, 0);

citys[71] = new Array('yl', '玉林', 'yulin', 'gxyulin', '36', 'guangxi', '广西', '', '', 138, 0);

citys[72] = new Array('xt', '邢台', 'xingtai', 'xingtai', '243', 'hebei', '河北', '', '', 5, 0);

citys[73] = new Array('qqhe', '齐齐哈尔', 'qiqihaer', 'qiqihaer', '225', 'heilongjiang', '黑龙江', '', '', 94, 0);

citys[74] = new Array('yc', '宜昌', 'yichang', 'yichang', '839', 'hubei', '湖北', '', '', 199, 0);

citys[75] = new Array('dt', '大同', 'datong', 'datong', '785', 'shanxi', '山西', '', '', 156, 0);

citys[76] = new Array('yt', '烟台', 'yantai', 'yantai', '4422', 'shandong', '山东', '', '', 118, 0);

citys[77] = new Array('yc', '银川', 'yinchuan', 'yc', '439', 'ningxia', '宁夏', '', '', 165, 0);

citys[78] = new Array('wz', '温州', 'wenzhou', 'wenzhou', '1228', 'zhejiang', '浙江', '', '', 28, 0);

citys[79] = new Array('ha', '淮安', 'huaian', 'huaian', '164', 'jiangsu', '江苏', '', '', 72, 0);

citys[80] = new Array('my', '绵阳', 'mianyang', 'mianyang', '485', 'sichuan', '四川', '', '', 49, 0);

citys[81] = new Array('bt', '包头', 'baotou', 'baotou', '321', 'neimenggu', '内蒙古', '', '', 146, 0);

citys[82] = new Array('fs', '抚顺', 'fushun', 'fushun', '139', 'liaoning', '辽宁', '', '', 58, 0);

citys[83] = new Array('ta', '泰安', 'taian', 'taian', '649', 'shandong', '山东', '', '', 305, 0);

citys[84] = new Array('jn', '济宁', 'jining', 'jining', '415', 'shandong', '山东', '', '', 304, 0);

citys[85] = new Array('lyg', '连云港', 'lianyungang', 'lianyungang', '563', 'jiangsu', '江苏', '', '', 71, 0);

citys[86] = new Array('hnz', '海南州', 'hainan', 'hainanzhou', '68', 'qinghai', '青海', '', '', 190, 0);

citys[87] = new Array('qz', '泉州', 'quanzhou', 'quanzhou', '678', 'fujian', '福建', '', '', 79, 0);

citys[88] = new Array('ay', '安阳', 'anyang', 'anyang', '159', 'henan', '河南', '', '', 109, 0);

citys[89] = new Array('hz', '惠州', 'huizhou', 'huizhou', '7138', 'guangdong', '广东', '', '', 23, 0);

citys[90] = new Array('hld', '葫芦岛', 'huludao', 'huludao', '3487', 'liaoning', '辽宁', '', '', 64, 0);

citys[91] = new Array('jx', '嘉兴', 'jiaxing', 'jiaxing', '2401', 'zhejiang', '浙江', '', '', 29, 0);

citys[92] = new Array('nt', '南通', 'nantong', 'nantong', '882', 'jiangsu', '江苏', '', '', 70, 0);

citys[93] = new Array('pzh', '攀枝花', 'panzhihua', 'panzhihua', '216', 'sichuan', '四川', '', '', 274, 0);

citys[94] = new Array('lz', '柳州', 'liuzhou', 'liuzhou', '347', 'guangxi', '广西', '', '', 133, 0);

citys[95] = new Array('dy', '东营', 'dongying', 'dongying', '49', 'shandong', '山东', '', '', 117, 0);

citys[96] = new Array('jms', '佳木斯', 'jiamusi', 'jiamusi', '187', 'heilongjiang', '黑龙江', '', '', 100, 0);

citys[97] = new Array('tl', '通辽', 'tongliao', 'tongliao', '95', 'neimenggu', '内蒙古', '', '', 149, 0);

citys[98] = new Array('dz', '德州', 'dezhou', 'dezhou', '312', 'shandong', '山东', '', '', 308, 0);

citys[99] = new Array('gz', '赣州', 'ganzhou', 'ganzhou', '283', 'jiangxi', '江西', '', '', 220, 0);

citys[100] = new Array('bz', '滨州', 'binzhou', 'binzhou', '92', 'shandong', '山东', '', '', 122, 0);

citys[101] = new Array('xy', '咸阳', 'xianyang', 'xianyang', '418', 'shanxi', '陕西', '', '', 179, 0);

citys[102] = new Array('jm', '江门', 'jiangmen', 'jiangmen', '350', 'guangdong', '广东', '', '', 21, 0);

citys[103] = new Array('zz', '漳州', 'zhangzhou', 'zhangzhou', '1635', 'fujian', '福建', '', '', 80, 0);

citys[104] = new Array('xx', '新乡', 'xinxiang', 'xinxiang', '272', 'henan', '河南', '', '', 108, 0);

citys[105] = new Array('xy', '襄阳', 'xiangyang', 'xiangyang', '146', 'hubei', '湖北', '', '', 196, 0);

citys[106] = new Array('nc', '南充', 'nanchong', 'nanchong', '424', 'sichuan', '四川', '', '', 51, 0);

citys[107] = new Array('lc', '聊城', 'liaocheng', 'liaocheng', '298', 'shandong', '山东', '', '', 309, 0);

citys[108] = new Array('zjk', '张家口', 'zhangjiakou', 'zhangjiakou', '1097', 'hebei', '河北', '', '', 7, 0);

citys[109] = new Array('cz', '沧州', 'cangzhou', 'cangzhou', '182', 'hebei', '河北', '', '', 9, 0);

citys[110] = new Array('shz', '石河子', 'shihezi', 'shihezi', '30', 'xinjiang', '新疆', '', '', 255, 0);

citys[111] = new Array('bj', '宝鸡', 'baoji', 'baoji', '166', 'shanxi', '陕西', '', '', 178, 0);

citys[112] = new Array('cf', '赤峰', 'chifeng', 'chifeng', '274', 'neimenggu', '内蒙古', '', '', 148, 0);

citys[113] = new Array('zj', '湛江', 'zhanjiang', 'zhanjiang', '484', 'guangdong', '广东', '', '', 264, 0);

citys[114] = new Array('sq', '商丘', 'shangqiu', 'shangqiu', '119', 'henan', '河南', '', '', 297, 0);

citys[115] = new Array('pds', '平顶山', 'pingdingshan', 'pingdingshan', '66', 'henan', '河南', '', '', 105, 0);

citys[116] = new Array('xy', '信阳', 'xinyang', 'xinyang', '64', 'henan', '河南', '', '', 298, 0);

citys[117] = new Array('jj', '九江', 'jiujiang', 'jiujiang', '497', 'jiangxi', '江西', '', '', 217, 0);

citys[118] = new Array('yk', '营口', 'yingkou', 'yingkou', '2821', 'liaoning', '辽宁', '', '', 61, 0);

citys[119] = new Array('bx', '本溪', 'benxi', 'benxi', '294', 'liaoning', '辽宁', '', '', 286, 0);

citys[120] = new Array('ly', '辽阳', 'liaoyang', 'liaoyang', '19', 'liaoning', '辽宁', '', '', 62, 0);

citys[121] = new Array('qz', '钦州', 'qinzhou', 'qinzhou', '22', 'guangxi', '广西', '', '', 136, 0);

citys[122] = new Array('hy', '衡阳', 'hengyang', 'hengyang', '423', 'hunan', '湖南', '', '', 207, 0);

citys[123] = new Array('st', '汕头', 'shantou', 'shantou', '927', 'guangdong', '广东', '', '', 19, 0);

citys[124] = new Array('wh', '芜湖', 'wuhu', 'wuhu', '305', 'anhui', '安徽', '', '', 124, 0);

citys[125] = new Array('hlbe', '呼伦贝尔', 'hulunbeier', 'hulunbeier', '813', 'neimenggu', '内蒙古', '', '', 151, 0);

citys[126] = new Array('xt', '湘潭', 'xiangtan', 'xiangtan', '180', 'hunan', '湖南', '', '', 206, 0);

citys[127] = new Array('cys', '朝阳市', 'chaoyang', 'chaoyang', '43', 'liaoning', '辽宁', '', '', 289, 0);

citys[128] = new Array('qy', '清远', 'qingyuan', 'qingyuan', '1662', 'guangdong', '广东', '', '', 270, 0);

citys[129] = new Array('sn', '遂宁', 'suining', 'suining', '94', 'sichuan', '四川', '', '', 276, 0);

citys[130] = new Array('tz', '泰州', 'taizhoujs', 'jstaizhou', '128', 'jiangsu', '江苏', '', '', 291, 0);

citys[131] = new Array('pt', '莆田', 'putian', 'putian', '183', 'fujian', '福建', '', '', 77, 0);

citys[132] = new Array('zz', '枣庄', 'zaozhuang', 'zaozhuang', '610', 'shandong', '山东', '', '', 116, 0);

citys[133] = new Array('lz', '泸州', 'luzhou', 'luzhou', '225', 'sichuan', '四川', '', '', 47, 0);

citys[134] = new Array('zs', '舟山', 'zhoushan', 'zhoushan', '2583', 'zhejiang', '浙江', '', '', 34, 0);

citys[135] = new Array('zj', '镇江', 'zhenjiang', 'zhenjiang', '320', 'jiangsu', '江苏', '', '', 290, 0);

citys[136] = new Array('kf', '开封', 'kaifeng', 'kaifeng', '826', 'henan', '河南', '', '', 293, 0);

citys[137] = new Array('eeds', '鄂尔多斯', 'eerduosi', 'eerduosi', '124', 'neimenggu', '内蒙古', '', '', 150, 0);

citys[138] = new Array('sy', '十堰', 'shiyan', 'shiyan', '170', 'hubei', '湖北', '', '', 197, 0);

citys[139] = new Array('yb', '延边', 'yanbian', 'yanbian', '758', 'jilin', '吉林', '', '', 92, 0);

citys[140] = new Array('hb', '淮北', 'huaibei', 'huaibei', '65', 'anhui', '安徽', '', '', 311, 0);

citys[141] = new Array('lf', '临汾', 'linfen', 'linfen', '222', 'shanxi', '山西', '', '', 164, 0);

citys[142] = new Array('cd', '常德', 'changde', 'changde', '176', 'hunan', '湖南', '', '', 210, 0);

citys[143] = new Array('jz', '荆州', 'jingzhou', 'jingzhou', '148', 'hubei', '湖北', '', '', 198, 0);

citys[144] = new Array('cz', '郴州', 'chenzhou', 'chenzhou', '857', 'hunan', '湖南', '', '', 211, 0);

citys[145] = new Array('dy', '德阳', 'deyang', 'deyang', '264', 'sichuan', '四川', '', '', 48, 0);

citys[146] = new Array('sx', '绍兴', 'shaoxing', 'shaoxing', '481', 'zhejiang', '浙江', '', '', 31, 0);

citys[147] = new Array('ny', '南阳', 'nanyang', 'nanyang', '227', 'henan', '河南', '', '', 111, 0);

citys[148] = new Array('hz', '菏泽', 'heze', 'heze', '147', 'shandong', '山东', '', '', 338, 0);

citys[149] = new Array('tz', '台州', 'taizhouzj', 'taizhouzj', '804', 'zhejiang', '浙江', '', '', 35, 0);

citys[150] = new Array('zy', '遵义', 'zunyi', 'zunyi', '371', 'guizhou', '贵州', '', '', 38, 0);

citys[151] = new Array('fx', '阜新', 'fuxin', 'fuxin', '38', 'liaoning', '辽宁', '', '', 287, 0);

citys[152] = new Array('yc', '盐城', 'yancheng', 'yancheng', '100', 'jiangsu', '江苏', '', '', 73, 0);

citys[153] = new Array('xq', '宿迁', 'suqian', 'suqian', '86', 'jiangsu', '江苏', '', '', 292, 0);

citys[154] = new Array('jz', '焦作', 'jiaozuo', 'jiaozuo', '154', 'henan', '河南', '', '', 106, 0);

citys[155] = new Array('cz', '长治', 'changzhi', 'changzhi', '198', 'shanxi', '山西', '', '', 158, 0);

citys[156] = new Array('ja', '吉安', 'jian', 'jian', '216', 'jiangxi', '江西', '', '', 221, 0);

citys[157] = new Array('dz', '达州', 'dazhou', 'dazhou', '61', 'sichuan', '四川', '', '', 53, 0);

citys[158] = new Array('lh', '漯河', 'luohe', 'luohe', '10', 'henan', '河南', '', '', 110, 0);

citys[159] = new Array('zmd', '驻马店', 'zhumadian', 'zhumadian', '36', 'henan', '河南', '', '', 300, 0);

citys[160] = new Array('hz', '汉中', 'hanzhong', 'hanzhong', '150', 'shanxi', '陕西', '', '', 182, 0);

citys[161] = new Array('hy', '河源', 'heyuan', 'heyuan', '188', 'guangdong', '广东', '', '', 268, 0);

citys[162] = new Array('tl', '铁岭', 'tieling', 'tieling', '38', 'liaoning', '辽宁', '', '', 288, 0);

citys[163] = new Array('jz', '晋中', 'jinzhong', 'jinzhong', '1175', 'shanxi', '山西', '', '', 161, 0);

citys[164] = new Array('ak', '安康', 'ankang', 'ankang', '42', 'shanxi', '陕西', '', '', 184, 0);

citys[165] = new Array('xg', '孝感', 'xiaogan', 'xiaogan', '35', 'hubei', '湖北', '', '', 327, 0);

citys[166] = new Array('yy', '岳阳', 'yueyang', 'yueyang', '208', 'hunan', '湖南', '', '', 209, 0);

citys[167] = new Array('zq', '肇庆', 'zhaoqing', 'zhaoqing', '317', 'guangdong', '广东', '', '', 265, 0);

citys[168] = new Array('hs', '衡水', 'hengshui', 'hengshui', '391', 'hebei', '河北', '', '', 11, 0);

citys[169] = new Array('mdj', '牡丹江', 'mudanjiang', 'mudanjiang', '250', 'heilongjiang', '黑龙江', '', '', 302, 0);

citys[170] = new Array('aq', '安庆', 'anqing', 'anqing', '94', 'anhui', '安徽', '', '', 127, 0);

citys[171] = new Array('hg', '黄冈', 'huanggang', 'huanggang', '66', 'hubei', '湖北', '', '', 328, 0);

citys[172] = new Array('ld', '娄底', 'loudi', 'loudi', '39', 'hunan', '湖南', '', '', 213, 0);

citys[173] = new Array('ls', '乐山', 'leshan', 'leshan', '1730', 'sichuan', '四川', '', '', 50, 0);

citys[174] = new Array('sp', '四平', 'siping', 'siping', '101', 'jilin', '吉林', '', '', 86, 0);

citys[175] = new Array('bb', '蚌埠', 'bengbu', 'bengbu', '113', 'anhui', '安徽', '', '', 125, 0);

citys[176] = new Array('cj', '昌吉', 'changji', 'changji', '6', 'xinjiang', '新疆', '', '', 250, 0);

citys[177] = new Array('sg', '韶关', 'shaoguan', 'shaoguan', '385', 'guangdong', '广东', '', '', 263, 0);

citys[178] = new Array('yj', '阳江', 'yangjiang', 'yangjiang', '1679', 'guangdong', '广东', '', '', 269, 0);

citys[179] = new Array('cz', '潮州', 'chaozhou', 'chaozhou', '426', 'guangdong', '广东', '', '', 271, 0);

citys[180] = new Array('zjj', '张家界', 'zhangjiajie', 'zhangjiajie', '1357', 'hunan', '湖南', '', '', 334, 0);

citys[181] = new Array('hh', '怀化', 'huaihua', 'huaihua', '89', 'hunan', '湖南', '', '', 336, 0);

citys[182] = new Array('xsbn', '西双版纳', 'xishuangbanna', 'xishuangbanna', '1634', 'yunnan', '云南', '', '', 235, 0);

citys[183] = new Array('sm', '三明', 'sanming', 'sanming', '93', 'fujian', '福建', '', '', 78, 0);

citys[184] = new Array('hn', '淮南', 'huainan', 'huainan', '89', 'anhui', '安徽', '', '', 310, 0);

citys[185] = new Array('yc', '运城', 'yuncheng', 'yuncheng', '143', 'shanxi', '山西', '', '', 162, 0);

citys[186] = new Array('ms', '眉山', 'meishan', 'meishan', '252', 'sichuan', '四川', '', '', 279, 0);

citys[187] = new Array('xc', '许昌', 'xuchang', 'xuchang', '60', 'henan', '河南', '', '', 295, 0);

citys[188] = new Array('sh', '绥化', 'suihua', 'suihua', '55', 'heilongjiang', '黑龙江', '', '', 102, 0);

citys[189] = new Array('fcg', '防城港', 'fangchenggang', 'fangchenggang', '621', 'guangxi', '广西', '', '', 318, 0);

citys[190] = new Array('yz', '永州', 'yongzhou', 'yongzhou', '64', 'hunan', '湖南', '', '', 212, 0);

citys[191] = new Array('yy', '益阳', 'yiyang', 'yiyang', '16', 'hunan', '湖南', '', '', 335, 0);

citys[192] = new Array('sr', '上饶', 'shangrao', 'shangrao', '1029', 'jiangxi', '江西', '', '', 224, 0);

citys[193] = new Array('qz', '衢州', 'quzhou', 'quzhou', '148', 'zhejiang', '浙江', '', '', 33, 0);

citys[194] = new Array('lps', '六盘水', 'liupanshui', 'liupanshui', '283', 'guizhou', '贵州', '', '', 37, 0);

citys[195] = new Array('zk', '周口', 'zhoukou', 'zhoukou', '48', 'henan', '河南', '', '', 299, 0);

citys[196] = new Array('bs', '白山', 'baishan', 'baishan', '351', 'jilin', '吉林', '', '', 89, 0);

citys[197] = new Array('la', '六安', 'luan', 'luan', '58', 'anhui', '安徽', '', '', 132, 0);

citys[198] = new Array('tl', '铜陵', 'tongling', 'tongling', '42', 'anhui', '安徽', '', '', 312, 0);

citys[199] = new Array('sz', '池州', 'chizhou', 'chizhou', '225', 'anhui', '安徽', '', '', 315, 0);

citys[200] = new Array('jc', '晋城', 'jincheng', 'jincheng', '113', 'shanxi', '山西', '', '', 159, 0);

citys[201] = new Array('hs', '黄石', 'huangshi', 'huangshi', '56', 'hubei', '湖北', '', '', 195, 0);

citys[202] = new Array('xx', '湘西', 'xiangxi', 'xiangxi', '824', 'hunan', '湖南', '', '', 337, 0);

citys[203] = new Array('yc', '宜春', 'yichunjx', 'jxyichun', '184', 'jiangxi', '江西', '', '', 222, 0);

citys[204] = new Array('mm', '茂名', 'maoming', 'maoming', '96', 'guangdong', '广东', '', '', 22, 0);

citys[205] = new Array('mz', '梅州', 'meizhou', 'meizhou', '143', 'guangdong', '广东', '', '', 266, 0);

citys[206] = new Array('ls', '凉山', 'liangshan', 'liangshan', '947', 'sichuan', '四川', '', '', 54, 0);

citys[207] = new Array('yb', '宜宾', 'yibin', 'yibin', '211', 'sichuan', '四川', '', '', 52, 0);

citys[208] = new Array('hz', '湖州', 'huzhou', 'huzhou', '2598', 'zhejiang', '浙江', '', '', 30, 0);

citys[209] = new Array('py', '濮阳', 'puyang', 'puyang', '41', 'henan', '河南', '', '', 294, 0);

citys[210] = new Array('cz', '滁州', 'chuzhou', 'chuzhou', '85', 'anhui', '安徽', '', '', 128, 0);

citys[211] = new Array('ya', '延安', 'yanan', 'yanan', '250', 'shanxi', '陕西', '', '', 181, 0);

citys[212] = new Array('nj', '内江', 'neijiang', 'neijiang', '63', 'sichuan', '四川', '', '', 277, 0);

citys[213] = new Array('np', '南平', 'nanping', 'nanping', '501', 'fujian', '福建', '', '', 81, 0);

citys[214] = new Array('smx', '三门峡', 'sanmenxia', 'sanmenxia', '57', 'henan', '河南', '', '', 296, 0);

citys[215] = new Array('ly', '辽源', 'liaoyuan', 'liaoyuan', '30', 'jilin', '吉林', '', '', 87, 0);

citys[216] = new Array('sy', '松原', 'songyuan', 'songyuan', '105', 'jilin', '吉林', '', '', 90, 0);

citys[217] = new Array('sys', '双鸭山', 'shuangyashan', 'shuangyashan', '13', 'heilongjiang', '黑龙江', '', '', 97, 0);

citys[218] = new Array('fy', '阜阳', 'fuyang', 'fuyang', '79', 'anhui', '安徽', '', '', 129, 0);

citys[219] = new Array('hs', '黄山', 'huangshan', 'huangshan', '1758', 'anhui', '安徽', '', '', 313, 0);

citys[220] = new Array('byne', '巴彦淖尔', 'bayannaoer', 'bayannaoer', '31', 'neimenggu', '内蒙古', '', '', 152, 0);

citys[221] = new Array('wn', '渭南', 'weinan', 'weinan', '225', 'shanxi', '陕西', '', '', 180, 0);

citys[222] = new Array('xn', '咸宁', 'xianning', 'xianning', '91', 'hubei', '湖北', '', '', 329, 0);

citys[223] = new Array('es', '恩施', 'enshi', 'enshi', '1348', 'hubei', '湖北', '', '', 331, 0);

citys[224] = new Array('fz', '抚州', 'fuzhouj', 'jxfuzhou', '44', 'jiangxi', '江西', '', '', 223, 0);

citys[225] = new Array('ly', '龙岩', 'longyan', 'longyan', '210', 'fujian', '福建', '', '', 82, 0);

citys[226] = new Array('th', '通化', 'tonghua', 'tonghua', '261', 'jilin', '吉林', '', '', 88, 0);

citys[227] = new Array('bc', '白城', 'baicheng', 'baicheng', '68', 'jilin', '吉林', '', '', 91, 0);

citys[228] = new Array('xc', '宣城', 'xuancheng', 'xuancheng', '304', 'anhui', '安徽', '', '', 316, 0);

citys[229] = new Array('xlgl', '锡林郭勒', 'xilinguole', 'xilinguole', '297', 'neimenggu', '内蒙古', '', '', 321, 0);

citys[230] = new Array('sy', '邵阳', 'shaoyang', 'shaoyang', '53', 'hunan', '湖南', '', '', 208, 0);

citys[231] = new Array('jdz', '景德镇', 'jingdezhen', 'jingdezhen', '417', 'jiangxi', '江西', '', '', 215, 0);

citys[232] = new Array('qj', '曲靖', 'qujing', 'qujing', '105', 'yunnan', '云南', '', '', 226, 0);

citys[233] = new Array('jy', '揭阳', 'jieyang', 'jieyang', '36', 'guangdong', '广东', '', '', 272, 0);

citys[234] = new Array('gy', '广元', 'guangyuan', 'guangyuan', '117', 'sichuan', '四川', '', '', 275, 0);

citys[235] = new Array('bz', '巴中', 'bazhong', 'bazhong', '34', 'sichuan', '四川', '', '', 281, 0);

citys[236] = new Array('jy', '济源', 'jiyuan', 'jiyuan', '25', 'henan', '河南', '', '', 112, 0);

citys[237] = new Array('hg', '鹤岗', 'hegang', 'hegang', '9', 'heilongjiang', '黑龙江', '', '', 96, 0);

citys[238] = new Array('hh', '黑河', 'heihe', 'heihe', '165', 'heilongjiang', '黑龙江', '', '', 101, 0);

citys[239] = new Array('ll', '吕梁', 'lvliang', 'lvliang', '46', 'shanxi', '山西', '', '', 323, 0);

citys[240] = new Array('ts', '天水', 'tianshui', 'tianshui', '98', 'gansu', '甘肃', '', '', 169, 0);

citys[241] = new Array('yl', '榆林', 'sxyulin', 'sxyulin', '29', 'shanxi', '陕西', '', '', 183, 0);

citys[242] = new Array('px', '萍乡', 'pingxiang', 'pingxiang', '120', 'jiangxi', '江西', '', '', 216, 0);

citys[243] = new Array('hm', '哈密', 'hami', 'hami', '6', 'xinjiang', '新疆', '', '', 244, 0);

citys[244] = new Array('yf', '云浮', 'yunfu', 'yunfu', '19', 'guangdong', '广东', '', '', 273, 0);

citys[245] = new Array('zg', '自贡', 'zigong', 'zigong', '161', 'sichuan', '四川', '', '', 46, 0);

citys[246] = new Array('ab', '阿坝', 'aba', 'aba', '269', 'sichuan', '四川', '', '', 283, 0);

citys[247] = new Array('nd', '宁德', 'ningde', 'ningde', '547', 'fujian', '福建', '', '', 83, 0);

citys[248] = new Array('mas', '马鞍山', 'maanshan', 'maanshan', '30', 'anhui', '安徽', '', '', 126, 0);

citys[249] = new Array('als', '阿拉善', 'alashan', 'alashan', '551', 'neimenggu', '内蒙古', '', '', 322, 0);

citys[250] = new Array('yq', '阳泉', 'yangquan', 'yangquan', '26', 'shanxi', '山西', '', '', 157, 0);

citys[251] = new Array('xy', '新余', 'xinyu', 'xinyu', '17', 'jiangxi', '江西', '', '', 218, 0);

citys[252] = new Array('ks', '喀什', 'kashidiqu', 'kashi', '4', 'xinjiang', '新疆', '', '', 247, 0);

citys[253] = new Array('bj', '毕节', 'bijie', 'bijie', '33', 'guizhou', '贵州', '', '', 41, 0);

citys[254] = new Array('qxn', '黔西南', 'qianxinan', 'qianxinan', '263', 'guizhou', '贵州', '', '', 42, 0);

citys[255] = new Array('jx', '鸡西', 'jixi', 'jixi', '97', 'heilongjiang', '黑龙江', '', '', 95, 0);

citys[256] = new Array('yc', '伊春', 'hljyichun', 'hljyichun', '258', 'heilongjiang', '黑龙江', '', '', 99, 0);

citys[257] = new Array('dxal', '大兴安岭', 'daxinganling', 'daxinganling', '52', 'heilongjiang', '黑龙江', '', '', 303, 0);

citys[258] = new Array('xz', '宿州', 'suzhouah', 'ahsuzhou', '93', 'anhui', '安徽', '', '', 130, 0);

citys[259] = new Array('wz', '梧州', 'wuzhou', 'wuzhou', '84', 'guangxi', '广西', '', '', 135, 0);

citys[260] = new Array('gg', '贵港', 'guigang', 'guigang', '23', 'guangxi', '广西', '', '', 137, 0);

citys[261] = new Array('sz', '朔州', 'shuozhou', 'shuozhou', '14', 'shanxi', '山西', '', '', 160, 0);

citys[262] = new Array('qy', '庆阳', 'qingyang', 'qingyang', '12', 'gansu', '甘肃', '', '', 174, 0);

citys[263] = new Array('ez', '鄂州', 'ezhou', 'ezhou', '41', 'hubei', '湖北', '', '', 201, 0);

citys[264] = new Array('aks', '阿克苏', 'akesu', 'akesu', '11', 'xinjiang', '新疆', '', '', 246, 0);

citys[265] = new Array('sw', '汕尾', 'shanwei', 'shanwei', '363', 'guangdong', '广东', '', '', 267, 0);

citys[266] = new Array('ga', '广安', 'guangan', 'guangan', '32', 'sichuan', '四川', '', '', 278, 0);

citys[267] = new Array('zy', '资阳', 'ziyang', 'ziyang', '52', 'sichuan', '四川', '', '', 282, 0);

citys[268] = new Array('as', '安顺', 'anshun', 'anshun', '193', 'guizhou', '贵州', '', '', 39, 0);

citys[269] = new Array('qdn', '黔东南', 'qiandongnan', 'qiandongnan', '728', 'guizhou', '贵州', '', '', 43, 0);

citys[270] = new Array('qth', '七台河', 'qitaihe', 'qitaihe', '4', 'heilongjiang', '黑龙江', '', '', 301, 0);

citys[271] = new Array('hs', '河池', 'hechi', 'hechi', '43', 'guangxi', '广西', '', '', 140, 0);

citys[272] = new Array('wh', '乌海', 'wuhai', 'wuhai', '9', 'neimenggu', '内蒙古', '', '', 147, 0);

citys[273] = new Array('zy', '张掖', 'zhangye', 'zhangye', '240', 'gansu', '甘肃', '', '', 171, 0);

citys[274] = new Array('jq', '酒泉', 'jiuquan', 'jiuquan', '445', 'gansu', '甘肃', '', '', 173, 0);

citys[275] = new Array('ln', '陇南', 'longnan', 'longnan', '30', 'gansu', '甘肃', '', '', 324, 0);

citys[276] = new Array('snj', '神农架', 'shennongjia', 'shennongjia', '223', 'hubei', '湖北', '', '', 333, 0);

citys[277] = new Array('klmy', '克拉玛依', 'kelamayi', 'kelamayi', '31', 'xinjiang', '新疆', '', '', 242, 0);

citys[278] = new Array('yl', '伊犁', 'yili', 'yili', '257', 'xinjiang', '新疆', '', '', 252, 0);

citys[279] = new Array('betl', '博尔塔拉', 'boertala', 'boertala', '2', 'xinjiang', '新疆', '', '', 251, 0);

citys[280] = new Array('alt', '阿勒泰', 'aletai', 'aletai', '55', 'xinjiang', '新疆', '', '', 254, 0);

citys[281] = new Array('ya', '雅安', 'yaan', 'yaan', '288', 'sichuan', '四川', '', '', 280, 0);

citys[282] = new Array('gz', '甘孜', 'ganzi', 'ganzi', '581', 'sichuan', '四川', '', '', 284, 0);

citys[283] = new Array('ls', '丽水', 'lishui', 'lishui', '725', 'zhejiang', '浙江', '', '', 285, 0);

citys[284] = new Array('bz', '亳州', 'bozhou', 'bozhou', '47', 'anhui', '安徽', '', '', 314, 0);

citys[285] = new Array('bs', '百色', 'baise', 'baise', '44', 'guangxi', '广西', '', '', 139, 0);

citys[286] = new Array('hz', '贺州', 'hezhou', 'hezhou', '146', 'guangxi', '广西', '', '', 319, 0);

citys[287] = new Array('wlcb', '乌兰察布', 'wulanchabu', 'wulanchabu', '79', 'neimenggu', '内蒙古', '', '', 153, 0);

citys[288] = new Array('zw', '中卫', 'zhongwei', 'zhongwei', '126', 'ningxia', '宁夏', '', '', 342, 0);

citys[289] = new Array('jc', '金昌', 'jinchang', 'jinchang', '3', 'gansu', '甘肃', '', '', 167, 0);

citys[290] = new Array('by', '白银', 'baiyin', 'baiyin', '5', 'gansu', '甘肃', '', '', 168, 0);

citys[291] = new Array('pl', '平凉', 'pingliang', 'pingliang', '17', 'gansu', '甘肃', '', '', 172, 0);

citys[292] = new Array('dx', '定西', 'dingxi', 'dingxi', '8', 'gansu', '甘肃', '', '', 175, 0);

citys[293] = new Array('tc', '铜川', 'tongchuan', 'tongchuan', '7', 'shanxi', '陕西', '', '', 177, 0);

citys[294] = new Array('qj', '潜江', 'qianjiang', 'qianjiang', '10', 'hubei', '湖北', '', '', 203, 0);

citys[295] = new Array('yt', '鹰潭', 'yingtan', 'yingtan', '41', 'jiangxi', '江西', '', '', 219, 0);

citys[296] = new Array('zt', '昭通', 'zhaotong', 'zhaotong', '58', 'yunnan', '云南', '', '', 229, 0);

citys[297] = new Array('bygl', '巴音郭楞', 'bayinguoleng', 'bayinguoleng', '39', 'xinjiang', '新疆', '', '', 249, 0);

citys[298] = new Array('lz', '林芝', 'linzhi', 'linzhi', '94', 'xicang', '西藏', '', '', 262, 0);

citys[299] = new Array('tr', '铜仁', 'tongren', 'tongren', '109', 'guizhou', '贵州', '', '', 40, 0);

citys[300] = new Array('lb', '来宾', 'laibin', 'laibin', '18', 'guangxi', '广西', '', '', 141, 0);

citys[301] = new Array('cz', '崇左', 'chongzuo', 'chongzuo', '14', 'guangxi', '广西', '', '', 320, 0);

citys[302] = new Array('xz', '忻州', 'xinzhou', 'xinzhou', '114', 'shanxi', '山西', '', '', 163, 0);

citys[303] = new Array('wz', '吴忠', 'wuzhong', 'wuzhong', '16', 'ningxia', '宁夏', '', '', 340, 0);

citys[304] = new Array('gy', '固原', 'guyuan', 'guyuan', '8', 'ningxia', '宁夏', '', '', 341, 0);

citys[305] = new Array('ww', '武威', 'wuwei', 'wuwei', '13', 'gansu', '甘肃', '', '', 170, 0);

citys[306] = new Array('gn', '甘南', 'gannan', 'gannan', '15', 'gansu', '甘肃', '', '', 326, 0);

citys[307] = new Array('hx', '海西', 'haixi', 'haixi', '254', 'qinghai', '青海', '', '', 193, 0);

citys[308] = new Array('jm', '荆门', 'jingmen', 'jingmen', '26', 'hubei', '湖北', '', '', 200, 0);

citys[309] = new Array('yx', '玉溪', 'yuxi', 'yuxi', '385', 'yunnan', '云南', '', '', 227, 0);

citys[310] = new Array('hh', '红河', 'honghe', 'honghe', '332', 'yunnan', '云南', '', '', 234, 0);

citys[311] = new Array('dh', '德宏', 'dehong', 'dehong', '41', 'yunnan', '云南', '', '', 238, 0);

citys[312] = new Array('tlf', '吐鲁番', 'tulufan', 'tulufan', '9', 'xinjiang', '新疆', '', '', 243, 0);

citys[313] = new Array('tc', '塔城', 'tacheng', 'tacheng', '1', 'xinjiang', '新疆', '', '', 253, 0);

citys[314] = new Array('al', '阿里', 'ali', 'ali', '2', 'xicang', '西藏', '', '', 261, 0);

citys[315] = new Array('qn', '黔南', 'qiannan', 'qiannan', '273', 'guizhou', '贵州', '', '', 44, 0);

citys[316] = new Array('hb', '鹤壁', 'hebi', 'hebi', '29', 'henan', '河南', '', '', 107, 0);

citys[317] = new Array('wzs', '五指山', 'wuzhishan', 'wuzhishan', '30', 'hainan', '海南', '', '', 353, 0);

citys[318] = new Array('xa', '兴安', 'xingan', 'xingan', '188', 'neimenggu', '内蒙古', '', '', 154, 0);

citys[319] = new Array('jyg', '嘉峪关', 'jiayuguan', 'jiayuguan', '142', 'gansu', '甘肃', '', '', 343, 0);

citys[320] = new Array('lx', '临夏', 'linxia', 'linxia', '18', 'gansu', '甘肃', '', '', 325, 0);

citys[321] = new Array('sl', '商洛', 'shangluo', 'shangluo', '20', 'shanxi', '陕西', '', '', 185, 0);

citys[322] = new Array('hd', '海东', 'haidong', 'haidong', '74', 'qinghai', '青海', '', '', 187, 0);

citys[323] = new Array('hb', '海北', 'haibei', 'haibei', '187', 'qinghai', '青海', '', '', 188, 0);

citys[324] = new Array('xt', '仙桃', 'xiantao', 'xiantao', '1', 'hubei', '湖北', '', '', 202, 0);

citys[325] = new Array('sz', '随州', 'suizhou', 'suizhou', '10', 'hubei', '湖北', '', '', 330, 0);

citys[326] = new Array('bs', '保山', 'baoshan', 'baoshan', '421', 'yunnan', '云南', '', '', 228, 0);

citys[327] = new Array('cx', '楚雄', 'chuxiong', 'chuxiong', '26', 'yunnan', '云南', '', '', 236, 0);

citys[328] = new Array('pe', '普洱', 'puer', 'puer', '74', 'yunnan', '云南', '', '', 231, 0);

citys[329] = new Array('lc', '临沧', 'lincang', 'lincang', '7', 'yunnan', '云南', '', '', 232, 0);

citys[330] = new Array('ws', '文山', 'wenshan', 'wenshan', '142', 'yunnan', '云南', '', '', 233, 0);

citys[331] = new Array('nj', '怒江', 'nujiang', 'nujiang', '2', 'yunnan', '云南', '', '', 239, 0);

citys[332] = new Array('dq', '迪庆', 'diqing', 'diqing', '198', 'yunnan', '云南', '', '', 240, 0);

citys[333] = new Array('ht', '和田', 'hetian', 'hetian', '1', 'xinjiang', '新疆', '', '', 245, 0);

citys[334] = new Array('tmsk', '图木舒克', 'tumushuke', 'tumushuke', '2', 'xinjiang', '新疆', '', '', 375, 0);

citys[335] = new Array('wjq', '五家渠', 'wujiaqu', 'wujiaqu', '4', 'xinjiang', '新疆', '', '', 376, 0);

citys[336] = new Array('wc', '文昌', 'wenchang', 'wc', '305', 'hainan', '海南', '', '', 397, 0);

citys[337] = new Array('qh', '琼海', 'qionghai', 'qionghai', '384', 'hainan', '海南', '', '', 399, 0);

citys[338] = new Array('dz', '儋州', 'danzhou', 'danzhou', '223', 'hainan', '海南', '', '', 400, 0);

citys[339] = new Array('wn', '万宁', 'wanning', 'wanning', '513', 'hainan', '海南', '', '', 401, 0);

citys[340] = new Array('df', '东方', 'dongfang', 'dongfang', '65', 'hainan', '海南', '', '', 402, 0);

citys[341] = new Array('da', '定安', 'dingan', 'dingan', '7', 'hainan', '海南', '', '', 403, 0);

citys[342] = new Array('tc', '屯昌', 'tunchang', 'tunchang', '3', 'hainan', '海南', '', '', 404, 0);

citys[343] = new Array('cm', '澄迈', 'chengmai', 'chengmai', '142', 'hainan', '海南', '', '', 405, 0);

citys[344] = new Array('lg', '临高', 'lingao', 'lingao', '30', 'hainan', '海南', '', '', 406, 0);

citys[345] = new Array('bs', '白沙', 'baisha', 'baisha', '2', 'hainan', '海南', '', '', 407, 0);

citys[346] = new Array('cj', '昌江', 'changjiang', 'changjiang', '28', 'hainan', '海南', '', '', 408, 0);

citys[347] = new Array('ld', '乐东', 'ledong', 'ledong', '45', 'hainan', '海南', '', '', 409, 0);

citys[348] = new Array('ls', '陵水', 'lingshui', 'lingshui', '504', 'hainan', '海南', '', '', 410, 0);

citys[349] = new Array('bt', '保亭', 'baoting', 'baoting', '29', 'hainan', '海南', '', '', 411, 0);

citys[350] = new Array('qz', '琼中', 'qiongzhong', 'qiongzhong', '12', 'hainan', '海南', '', '', 412, 0);

citys[351] = new Array('ylx', '宜兰县', 'yilanxian', 'ylxian', '1', 'taiwan', '台湾', '', '', 393, 0);

citys[352] = new Array('tb', '台北', 'taibei', 'taipei', '137', 'taiwan', '台湾', '', '', 378, 0);

citys[353] = new Array('xb', '新北', 'xinbei', 'newnorth', '14', 'taiwan', '台湾', '', '', 379, 0);

citys[354] = new Array('tz', '台中', 'taizhong', 'taichung', '14', 'taiwan', '台湾', '', '', 380, 0);

citys[355] = new Array('tn', '台南', 'tainan', 'tainan', '1', 'taiwan', '台湾', '', '', 381, 0);

citys[356] = new Array('gx', '高雄', 'gaoxiong', 'kaohsiung', '17', 'taiwan', '台湾', '', '', 382, 0);

citys[357] = new Array('xz', '新竹', 'xinzhu', 'hsinchu', '2', 'taiwan', '台湾', '', '', 384, 0);

citys[358] = new Array('jy', '嘉义', 'jiayi', 'chiayi', '1', 'taiwan', '台湾', '', '', 385, 0);

citys[359] = new Array('tys', '桃园市', 'taoyuanshi', 'taoyuan', '1', 'taiwan', '台湾', '', '', 386, 0);

citys[360] = new Array('hlx', '花莲县', 'hualianxian', 'hlx', '48', 'taiwan', '台湾', '', '', 394, 0);
...
citys[363] = new Array('pdx', '屏东县', 'pingdongxian', 'pingtungcounty', '4', 'taiwan', '台湾', '', '', 2764, 0);

var abroadcitys = new Array();

abroadcitys[0] = new Array('yazhuang', '芽庄', 'yazhuang', 'yazhuang', '11', 'qinghe', '庆和', '', '', 2840, 1, '+07:00');

abroadcitys[1] = new Array('hjha', '黄金海岸', 'huangjinhaian', 'goldcoast', '10', '', '昆士兰', '', '', 532, 1, '+10:00');

abroadcitys[2] = new Array('dld', '多伦多', 'duolunduo', 'toronto', '41', '', '安大略省', '', '', 712, 1, '-06:00');

abroadcitys[3] = new Array('wdly', '维多利亚', 'weiduoliya', 'weiduoliya', '5', '', '不列颠哥伦比亚省', '', '', 716, 1, '-08:00');

abroadcitys[4] = new Array('ns', '尼斯', 'nisi', 'nice', '2', '', '普罗旺斯-阿尔卑斯-蓝色海岸', '', '', 951, 1, '+01:00');

abroadcitys[5] = new Array('aikesi', '艾克斯', 'aikesi', 'aixenprovence', '1', '', '普罗旺斯-阿尔卑斯-蓝色海岸', '', '', 953, 1, '+01:00');

abroadcitys[6] = new Array('bl', '柏林', 'bailin', 'berlin', '3', '', '柏林', '', '', 968, 1, '+01:00');

abroadcitys[7] = new Array('yd', '雅典', 'yadian', 'athens', '21', '', '阿提卡大区', '', '', 1019, 1, '+02:00');

abroadcitys[8] = new Array('ml', '米兰', 'milan', 'milan', '7', '', '伦巴第', '', '', 1150, 1, '+01:00');

abroadcitys[9] = new Array('wns', '威尼斯', 'weinisi', 'venice', '5', '', '威尼托', '', '', 1155, 1, '+01:00');

abroadcitys[10] = new Array('flls', '佛罗伦萨', 'foluolunsa', 'florence', '2', '', '托斯卡纳', '', '', 1174, 1, '+01:00');

abroadcitys[11] = new Array('lm', '罗马', 'luoma', 'rome', '5', '', '拉齐奥', '', '', 1181, 1, '+01:00');

abroadcitys[12] = new Array('mgw', '名古屋', 'mingguwu', 'nagoya', '56', 'aizhi', '爱知', '', '', 1193, 1, '+09:00');

abroadcitys[13] = new Array('zh', '札幌', 'zhahuang', 'sapporo', '6', 'beihaidao', '北海道', '', '', 1194, 1, '+09:00');

abroadcitys[14] = new Array('fg', '福冈', 'fugang', 'fukuoka', '2', 'fugang', '福冈', '', '', 1197, 1, '+09:00');

abroadcitys[15] = new Array('ml', '马累', 'malei', 'male', '1', '', '马累', '', '', 1620, 1, '+05:00');

abroadcitys[16] = new Array('sbdb', '圣彼得堡', 'shengbidebao', 'saintpetersburg', '6', '', '西北', '', '', 1914, 1, '+03:00');

abroadcitys[17] = new Array('bsln', '巴塞罗那', 'basailuona', 'barcelona', '37', '', '巴塞罗那', '', '', 2049, 1, '+01:00');

abroadcitys[18] = new Array('mdl', '马德里', 'madeli', 'madrid', '9', '', '马德里', '', '', 2060, 1, '+01:00');

abroadcitys[19] = new Array('adb', '爱丁堡', 'aidingbao', 'edinburgh', '3', '', '苏格兰', '', '', 2210, 1, '+00:00');

abroadcitys[20] = new Array('ld', '伦敦', 'lundun', 'london', '12', '', '英格兰', '', '', 2242, 1, '+00:00');

abroadcitys[21] = new Array('hsd', '华盛顿', 'huashengdun', 'washington', '2', '', '哥伦比亚特区', '', '', 2350, 1, '-05:00');

abroadcitys[22] = new Array('xyt', '西雅图', 'xiyatu', 'seattle', '1', '', '华盛顿', '', '', 2353, 1, '-08:00');

abroadcitys[23] = new Array('jjs', '旧金山', 'jiujinshan', 'sanfrancisco', '11', '', '加利福尼亚', '', '', 2360, 1, '-08:00');

abroadcitys[24] = new Array('bsd', '波士顿', 'boshidun', 'boston', '5', '', '马萨诸塞', '', '', 2406, 1, '-05:00');

abroadcitys[25] = new Array('lswjs', '拉斯维加斯', 'lasiweijiasi', 'lasvegas', '21', '', '内华达', '', '', 2460, 1, '-07:00');

abroadcitys[26] = new Array('ny', '纽约', 'niuyue', 'newyork', '21', '', '纽约', '', '', 2465, 1, '-05:00');

abroadcitys[27] = new Array('alw', '埃里温', 'ailiwen', 'yerwin', '1', '', '埃里温市', '', '', 517, 1, '+05:00');

abroadcitys[28] = new Array('blsb', '布里斯班', 'bulisiban', 'brisbane', '9', '', '昆士兰', '', '', 531, 1, '+10:00');

abroadcitys[29] = new Array('hbt', '霍巴特', 'huobate', 'hobart', '2', '', '塔斯马尼亚', '', '', 547, 1, '+10:00');

abroadcitys[30] = new Array('nkse', '纽卡斯尔', 'niukasier', 'niukasier', '1', '', '新南威尔士', '', '', 558, 1, '+10:00');

abroadcitys[31] = new Array('secb', '萨尔茨堡', 'saercibao', 'salzburg', '1', '', '萨尔茨堡', '', '', 565, 1, '+01:00');

abroadcitys[32] = new Array('wyn', '维也纳', 'weiyena', 'vienna', '2', '', '维也纳', '', '', 569, 1, '+01:00');

abroadcitys[33] = new Array('blse', '布鲁塞尔', 'bulusaier', 'brussels', '2', '', '布鲁塞尔首都大区', '', '', 599, 1, '+01:00');

abroadcitys[34] = new Array('sbl', '圣保罗', 'shengbaoluo', 'stpaul', '1', '', '东南地区', '', '', 660, 1, '-03:00');

abroadcitys[35] = new Array('wl', '文莱', 'wenlai', 'brunei', '3', '', '文莱', '', '', 664, 1, '+08:00');

abroadcitys[36] = new Array('sfy', '索非亚', 'suofeiya', 'sofia', '1', '', '索非亚市', '', '', 665, 1, '+02:00');

abroadcitys[37] = new Array('fldld', '弗雷德里顿', 'fuleidelidun', 'fredericton', '1', '', '新不伦瑞克省', '', '', 710, 1, '-04:00');

abroadcitys[38] = new Array('wnb', '温尼伯', 'wennibo', 'winnipeg', '4', '', '马尼托巴省', '', '', 713, 1, '-06:00');

abroadcitys[39] = new Array('ylnf', '耶洛奈夫', 'yeluonaifu', 'yellowknife', '1', '', '西北地区', '', '', 717, 1, '-07:00');

abroadcitys[40] = new Array('blg', '布拉格', 'bulage', 'prague', '1', 'bulage', '布拉格', '', '', 775, 1, '+01:00');

abroadcitys[41] = new Array('gbhg', '哥本哈根', 'gebenhagen', 'copenhagen', '2', '', '京畿', '', '', 785, 1, '+01:00');

abroadcitys[42] = new Array('kl', '开罗', 'kailuo', 'cairo', '2', '', '开罗', '', '', 823, 1, '+02:00');

abroadcitys[43] = new Array('hexj', '赫尔辛基', 'heerxinji', 'helsinki', '2', '', '新地区', '', '', 847, 1, '+02:00');

abroadcitys[44] = new Array('asb', '埃斯波', 'aisibo', 'espoo', '1', '', '新地区', '', '', 848, 1, '+02:00');

abroadcitys[45] = new Array('ywsql', '于韦斯屈莱', 'yuweisiqulai', 'jyvaskyla', '1', '', '中芬兰区', '', '', 853, 1, '+02:00');

abroadcitys[46] = new Array('ml', '默伦', 'molun', 'mullen', '2', '', '法兰西岛', '', '', 857, 1, '+01:00');

abroadcitys[47] = new Array('fes', '凡尔赛', 'fanersai', 'versailles', '1', '', '法兰西岛', '', '', 858, 1, '+01:00');

abroadcitys[48] = new Array('nte', '楠泰尔', 'nantaier', 'nantaire', '5', '', '法兰西岛', '', '', 860, 1, '+01:00');

abroadcitys[49] = new Array('klty', '克雷泰伊', 'keleitaiyi', 'cretay', '1', '', '法兰西岛', '', '', 862, 1, '+01:00');

abroadcitys[50] = new Array('le', '里尔', 'lier', 'lille', '1', '', '北部-加莱海峡-皮卡第', '', '', 878, 1, '+01:00');

abroadcitys[51] = new Array('blw', '布卢瓦', 'buluwa', 'blois', '1', '', '中央-卢瓦尔谷', '', '', 890, 1, '+01:00');

abroadcitys[52] = new Array('ar', '阿让', 'arang', 'agen', '1', '', '阿基坦-利穆赞-普瓦图-夏朗德', '', '', 920, 1, '+01:00');

abroadcitys[53] = new Array('nm', '尼姆', 'nimu', 'nim', '1', '', '朗格多克-鲁西永-南部-比利牛', '', '', 931, 1, '+01:00');

abroadcitys[54] = new Array('la', '里昂', 'liang', 'lyon', '1', '', '奥弗涅-罗讷-阿尔卑斯', '', '', 940, 1, '+01:00');

abroadcitys[55] = new Array('anx', '阿讷西', 'anaxi', 'annexi', '1', '', '奥弗涅-罗讷-阿尔卑斯', '', '', 944, 1, '+01:00');

abroadcitys[56] = new Array('awnw', '阿维尼翁', 'aweiniweng', 'avignon', '1', '', '普罗旺斯-阿尔卑斯-蓝色海岸', '', '', 955, 1, '+01:00');

abroadcitys[57] = new Array('dsedf', '杜塞尔多夫', 'dusaierduofu', 'dusseldorf', '1', '', '北莱茵-威斯特法伦', '', '', 973, 1, '+01:00');

abroadcitys[58] = new Array('kl', '科隆', 'kelong', 'cologne', '1', '', '北莱茵-威斯特法伦', '', '', 974, 1, '+01:00');

abroadcitys[59] = new Array('flkf', '法兰克福', 'falankefu', 'frankfurt', '9', '', '黑森', '', '', 978, 1, '+01:00');

abroadcitys[60] = new Array('xbe', '下拜恩', 'xiabaien', 'lowerbyrne', '1', '', '拜恩（巴伐利亚）', '', '', 990, 1, '+01:00');

abroadcitys[61] = new Array('bdps', '布达佩斯', 'budapeisi', 'budapest', '8', '', '布达佩斯', '', '', 1067, 1, '+01:00');

abroadcitys[62] = new Array('bd', '冰岛', 'bingdao', 'iceland', '1', '', '冰岛', '', '', 1087, 1, '+00:00');

abroadcitys[63] = new Array('yjd', '雅加达', 'yajiada', 'jakarta', '2', '', '大雅加达首都特区', '', '', 1124, 1, '+07:00');

abroadcitys[64] = new Array('wl', '万隆', 'wanlong', 'bandung', '1', '', '西爪哇省', '', '', 1126, 1, '+07:00');

abroadcitys[65] = new Array('dbl', '都柏林', 'erbailin', 'dublin', '1', '', '伦斯特省', '', '', 1133, 1, '+00:00');

abroadcitys[66] = new Array('ylsl', '耶路撒冷', 'yelusaleng', 'jerusalem', '1', '', '耶路撒冷区', '', '', 1141, 1, '+02:00');

abroadcitys[67] = new Array('bs', '比萨', 'bisa', 'pisa', '1', '', '托斯卡纳', '', '', 1177, 1, '+01:00');

abroadcitys[68] = new Array('hb', '横滨', 'hengbin', 'yokohama', '8', 'shennaichuan', '神奈川', '', '', 1192, 1, '+09:00');

abroadcitys[69] = new Array('sh', '神戸', 'shenhu', 'kobe', '2', 'bingku', '兵库', '', '', 1195, 1, '+09:00');

abroadcitys[70] = new Array('cq', '川崎', 'chuanqi', 'kawasaki', '1', 'shennaichuan', '神奈川', '', '', 1198, 1, '+09:00');

abroadcitys[71] = new Array('qy', '埼玉', 'qiyu', 'saitama', '1', 'qiyu', '埼玉', '', '', 1199, 1, '+09:00');

abroadcitys[72] = new Array('j', '堺', 'jie', 'sakai', '4', 'daban', '大阪', '', '', 1204, 1, '+09:00');

abroadcitys[73] = new Array('xmy', '相模原', 'xiangmoyuan', 'sagamihara', '2', 'shennaichuan', '神奈川', '', '', 1208, 1, '+09:00');

abroadcitys[74] = new Array('cq', '船桥', 'chuanqiao', 'funabashi', '1', 'qianye', '千叶', '', '', 1212, 1, '+09:00');

abroadcitys[75] = new Array('bwz', '八王子', 'bawangzi', 'hachioji', '3', 'dongjing', '东京', '', '', 1213, 1, '+09:00');

abroadcitys[76] = new Array('ddb', '东大阪', 'dongdaban', 'higashiosaka', '4', 'daban', '大阪', '', '', 1216, 1, '+09:00');

abroadcitys[77] = new Array('jb', '金边', 'jinbian', 'phnompenh', '22', '', '金边市', '', '', 1232, 1, '+07:00');

abroadcitys[78] = new Array('xl', '暹粒', 'xianli', 'siemreap', '9', '', '暹粒省', '', '', 1237, 1, '+07:00');

abroadcitys[79] = new Array('xhnk', '西哈努克', 'xihanuke', 'sihanouk', '1', '', '西哈努克省', '', '', 1238, 1, '+07:00');

abroadcitys[80] = new Array('cz', '柴桢', 'chaizhen', 'firewood', '1', '', '柴桢', '', '', 1240, 1, '+07:00');

abroadcitys[81] = new Array('nlb', '内罗毕', 'neiluobi', 'nairobi', '1', '', '内罗毕', '', '', 1284, 1, '+03:00');

abroadcitys[82] = new Array('mbs', '蒙巴萨', 'mengbasa', 'mombasa', '1', '', '滨海省', '', '', 1285, 1, '+03:00');

abroadcitys[83] = new Array('rc', '仁川', 'renchuan', 'incheon', '1', '', '仁川', '', '', 1293, 1, '+09:00');

abroadcitys[84] = new Array('ws', '乌山', 'wushan', 'oshan', '1', '', '京畿道', '', '', 1447, 1, '+09:00');

abroadcitys[85] = new Array('wx', '万象', 'wanxiang', 'vientiane', '1', '', '万象首都', '', '', 1461, 1, '+07:00');

abroadcitys[86] = new Array('bc', '槟城', 'bincheng', 'penang', '14', '', '槟榔屿', '', '', 1496, 1, '+08:00');

abroadcitys[87] = new Array('mlj', '马六甲', 'maliujia', 'malacca', '8', '', '马六甲', '', '', 1527, 1, '+08:00');

abroadcitys[88] = new Array('ylyy', '亚罗牙也', 'yaluoyaye', 'arroyoalso', '1', '', '马六甲', '', '', 1528, 1, '+08:00');

abroadcitys[89] = new Array('yb', '怡保', 'yibao', 'ipoh', '1', '', '霹雳', '', '', 1550, 1, '+08:00');

abroadcitys[90] = new Array('fsg', '丰盛港', 'fengshenggang', 'mercedesport', '1', '', '柔佛', '', '', 1552, 1, '+08:00');

abroadcitys[91] = new Array('xs', '新山', 'xinshan', 'johor', '12', '', '柔佛', '', '', 1558, 1, '+08:00');

abroadcitys[92] = new Array('dyl', '斗亚兰', 'eryalan', 'doolan', '1', '', '沙巴', '', '', 1574, 1, '+08:00');

abroadcitys[93] = new Array('gdmld', '哥打马鲁都', 'gedamaluer', 'kotamarutu', '1', '', '沙巴', '', '', 1576, 1, '+08:00');

abroadcitys[94] = new Array('xbn', '仙本那', 'xianbenna', 'sakamoto', '36', '', '沙巴', '', '', 1588, 1, '+08:00');

abroadcitys[95] = new Array('bdl', '八打灵', 'badaling', 'petition', '2', '', '雪兰莪', '', '', 1600, 1, '+08:00');

abroadcitys[96] = new Array('glxle', '瓜拉雪兰莪', 'gualaxuelane', 'guaraselangor', '10', '', '雪兰莪', '', '', 1603, 1, '+08:00');

abroadcitys[97] = new Array('sban', '沙白安南', 'shabaiannan', 'sandwhiteannan', '1', '', '雪兰莪', '', '', 1604, 1, '+08:00');

abroadcitys[98] = new Array('xb', '雪邦', 'xuebang', 'spontan', '4', '', '雪兰莪', '', '', 1607, 1, '+08:00');

abroadcitys[99] = new Array('fld', '费利杜', 'feilidu', 'felicu', '2', '', '费利杜', '', '', 1616, 1, '+05:00');

abroadcitys[100] = new Array('mxgc', '墨西哥城', 'moxigecheng', 'mexico', '1', '', '联邦区', '', '', 1646, 1, '-06:00');

abroadcitys[101] = new Array('ksblk', '卡萨布兰卡', 'kasabulanka', 'casablanca', '7', '', '卡萨布兰卡', '', '', 1697, 1, '+00:00');

abroadcitys[102] = new Array('mlks', '马拉喀什', 'malakashi', 'marrakech', '1', '', '马拉喀什', '', '', 1699, 1, '+00:00');

abroadcitys[103] = new Array('wdhk', '温得和克', 'wendeheke', 'windhoek', '1', '', '霍马斯', '', '', 1702, 1, '+01:00');

abroadcitys[104] = new Array('jdmd', '加德满都', 'jiademaner', 'kathmandu', '6', '', '加德满都', '', '', 1711, 1, '+05:45');

abroadcitys[105] = new Array('amstd', '阿姆斯特丹', 'amusitedan', 'amsterdam', '2', '', '北荷兰', '', '', 1728, 1, '+01:00');

abroadcitys[106] = new Array('hy', '海牙', 'haiya', 'thehague', '1', '', '南荷兰', '', '', 1730, 1, '+01:00');

abroadcitys[107] = new Array('hmed', '哈密尔顿', 'hamierdun', 'hamilton', '2', '', '怀卡托', '', '', 1744, 1, '+12:00');

abroadcitys[108] = new Array('bpmsd', '北帕默斯顿', 'beipmsd', 'beipmsd', '1', '', '玛纳瓦图/旺格努伊', '', '', 1748, 1, '+12:00');

abroadcitys[109] = new Array('lm', '利马', 'lima', 'lima', '2', '', '利马', '', '', 1795, 1, '-05:00');

abroadcitys[110] = new Array('dgs', '迪戈斯', 'digesi', 'digos', '2', 'dawoqu', '达沃区', '', '', 1798, 1, '+08:00');

abroadcitys[111] = new Array('lsb', '里斯本', 'lisiben', 'lisbon', '7', '', '大里斯本', '', '', 1871, 1, '+00:00');

abroadcitys[112] = new Array('yekck', '伊尔库茨克', 'yierkucike', 'irkutsk', '1', '', '西伯利亚', '', '', 1957, 1, '+08:00');

abroadcitys[113] = new Array('hcw', '海参崴', 'haicanwei', 'vladivostok', '1', '', '远东', '', '', 1968, 1, '+09:00');

abroadcitys[114] = new Array('lyd', '利雅得', 'liyade', 'riyadh', '2', '', '利雅得', '', '', 1982, 1, '+03:00');

abroadcitys[115] = new Array('mlj', '马拉加', 'malajia', 'malaga', '1', '', '马拉加', '', '', 2024, 1, '+01:00');

abroadcitys[116] = new Array('swly', '塞维利亚', 'saiweiliya', 'seville', '1', '', '塞维利亚', '', '', 2025, 1, '+01:00');

abroadcitys[117] = new Array('pem', '帕尔马', 'paem', 'paem', '1', '', '巴利阿里群岛', '', '', 2030, 1, '+01:00');

abroadcitys[118] = new Array('hln', '赫罗纳', 'heluona', 'girona', '1', '', '赫罗纳', '', '', 2050, 1, '+01:00');

abroadcitys[119] = new Array('blxy', '巴伦西亚', 'balunxiya', 'valencia', '1', '', '巴伦西亚', '', '', 2068, 1, '+01:00');

abroadcitys[120] = new Array('klp', '科伦坡', 'kelunpo', 'colombo', '1', '', '科伦坡县', '', '', 2069, 1, '+05:30');

abroadcitys[121] = new Array('ngb', '尼甘布', 'niganbu', 'negambo', '3', '', '加姆珀哈县', '', '', 2075, 1, '+05:30');

abroadcitys[122] = new Array('sdgem', '斯德哥尔摩', 'sidegeermo', 'stockholm', '1', '', '斯德哥尔摩省', '', '', 2117, 1, '+01:00');

abroadcitys[123] = new Array('sls', '苏黎世', 'sulishi', 'zurich', '2', '', '苏黎世', '', '', 2124, 1, '+01:00');

abroadcitys[124] = new Array('ben', '伯尔尼', 'boerni', 'berni', '1', '', '伯尔尼', '', '', 2125, 1, '+01:00');

abroadcitys[125] = new Array('sjl', '圣加仑', 'shengjialun', 'stgallen', '1', '', '圣加仑', '', '', 2127, 1, '+01:00');

abroadcitys[126] = new Array('rnw', '日内瓦', 'rineiwa', 'geneva', '1', '', '日内瓦', '', '', 2129, 1, '+01:00');

abroadcitys[127] = new Array('akl', '安卡拉', 'ankala', 'ankara', '1', '', '安卡拉', '', '', 2186, 1, '+02:00');

abroadcitys[128] = new Array('jf', '基辅', 'jifu', 'kiev', '1', '', '基辅市', '', '', 2200, 1, '+02:00');

abroadcitys[129] = new Array('db', '迪拜', 'dibai', 'dubai', '7', '', '迪拜酋长国', '', '', 2203, 1, '+04:00');

abroadcitys[130] = new Array('bmh', '伯明翰', 'bominghan', 'birmingham', '1', '', '英格兰', '', '', 2222, 1, '+00:00');

abroadcitys[131] = new Array('lst', '列斯特', 'liesite', 'lester', '1', '', '英格兰', '', '', 2240, 1, '+00:00');

abroadcitys[132] = new Array('mcst', '曼彻斯特', 'manchesite', 'manchester', '1', '', '英格兰', '', '', 2243, 1, '+00:00');

abroadcitys[133] = new Array('sdl', '桑德兰', 'sangdelan', 'sunderland', '1', '', '英格兰', '', '', 2254, 1, '+00:00');

abroadcitys[134] = new Array('dls', '达拉斯', 'dalasi', 'dallas', '2', '', '德克萨斯', '', '', 2308, 1, '-06:00');

abroadcitys[135] = new Array('klfl', '克利夫兰', 'kelifulan', 'cleveland', '1', '', '俄亥俄', '', '', 2317, 1, '-05:00');

abroadcitys[136] = new Array('ald', '奥兰多', 'aolanduo', 'orlando', '15', '', '佛罗里达', '', '', 2338, 1, '-05:00');

abroadcitys[137] = new Array('mam', '迈阿密', 'maiami', 'miami', '34', '', '佛罗里达', '', '', 2343, 1, '-05:00');

abroadcitys[138] = new Array('sdg', '圣迭戈', 'shengdiege', 'sandiego', '1', '', '加利福尼亚', '', '', 2362, 1, '-08:00');

abroadcitys[139] = new Array('shs', '圣何塞', 'shenghs', 'shenghs', '7', '', '加利福尼亚', '', '', 2363, 1, '-08:00');

abroadcitys[140] = new Array('xael', '新奥尔良', 'xinaoerliang', 'neworleans', '8', '', '路易斯安那', '', '', 2395, 1, '-06:00');

abroadcitys[141] = new Array('bfl', '布法罗', 'bufaluo', 'buffalo', '1', '', '纽约', '', '', 2463, 1, '-05:00');

abroadcitys[142] = new Array('txs', '檀香山', 'tanxiangshan', 'honolulu', '9', '', '夏威夷', '', '', 2498, 1, '-10:00');

abroadcitys[143] = new Array('ytld', '亚特兰大', 'yatelanda', 'atlanta', '1', '', '佐治亚', '', '', 2550, 1, '-05:00');

abroadcitys[144] = new Array('hn', '河内', 'henei', 'hanoi', '9', '', '河内市', '', '', 2582, 1, '+07:00');

abroadcitys[145] = new Array('hzm', '胡志明', 'huzhiming', 'hochiminh', '26', '', '胡志明市', '', '', 2583, 1, '+07:00');

abroadcitys[146] = new Array('fj', '斐济', 'feiji', 'fiji', '1', '', '苏瓦', '', '', 2601, 1, '+12:00');

abroadcitys[147] = new Array('dbls', '第比利斯', 'dibilisi', 'tbilisi', '8', '', '第比利斯', '', '', 2603, 1, '+04:00');

abroadcitys[148] = new Array('hsadlsqd', '荷属安的列斯群岛', 'heshuandeliesiqundao', 'netherlandsantilles', '1', '', '荷属安的列斯群岛', '', '', 2609, 1, '-04:00');

abroadcitys[149] = new Array('dke', '达喀尔', 'dakaer', 'dakar', '1', '', '达喀尔', '', '', 2613, 1, '+00:00');

abroadcitys[150] = new Array('qzy', '泉佐野', 'quanzuoye', 'izumisano', '8', 'daban', '大阪', '', '', 2630, 1, '+09:00');

abroadcitys[151] = new Array('mataram', '马塔兰', 'mataram', 'mataram', '2', 'nusaenggarabarat', '西努沙登加拉', '', '', 2714, 1, '+08:00');

abroadcitys[152] = new Array('hg', '函馆', 'hanguan', 'hakodate', '1', 'beihaidao', '北海道', '', '', 2715, 1, '+09:00');

abroadcitys[153] = new Array('saipan', '塞班岛', 'saipan', 'saipan', '33', 'northernmariana', '北马里亚纳', '', '', 2716, 1, '+10:00');

abroadcitys[154] = new Array('pasai', '帕赛', 'pasai', 'pasay', '6', 'maniladaduhui', '马尼拉大都会', '', '', 2719, 1, '+08:00');

abroadcitys[155] = new Array('maynila', '马尼拉', 'maynila', 'maynila', '9', 'maniladaduhui', '马尼拉大都会', '', '', 2720, 1, '+08:00');

abroadcitys[156] = new Array('makadi', '马卡蒂', 'makadi', 'makati', '4', 'maniladaduhui', '马尼拉大都会', '', '', 2723, 1, '+08:00');

abroadcitys[157] = new Array('paxige', '帕西格', 'paxige', 'pasig', '2', 'maniladaduhui', '马尼拉大都会', '', '', 2730, 1, '+08:00');

abroadcitys[158] = new Array('tajige', '塔吉格', 'tajige', 'tajig', '1', 'maniladaduhui', '马尼拉大都会', '', '', 2733, 1, '+08:00');

abroadcitys[159] = new Array('bashu', '巴蜀', 'bashu', 'bayu', '1', 'prachuap', '班武里府', '', '', 2735, 1, '+7:00');

abroadcitys[160] = new Array('huaxin', '华欣', 'huaxin', 'huaxin', '20', 'prachuap', '班武里府', '', '', 2741, 1, '+7:00');

abroadcitys[161] = new Array('beilan', '北榄', 'beilan', 'northernlam', '5', 'beilan', '北榄', '', '', 2744, 1, '+7:00');

abroadcitys[162] = new Array('jiami', '甲米', 'jiami', 'krabi', '301', 'jiami', '甲米', '', '', 2746, 1, '+7:00');

abroadcitys[163] = new Array('qinglaishi', '清莱', 'qinglaishi', 'chiangrai', '1', 'qinglai', '清莱', '', '', 2747, 1, '+7:00');

abroadcitys[164] = new Array('nb', '那霸', 'naba', 'naha', '16', 'chongsheng', '冲绳', '', '', 2749, 1, '+09:00');

abroadcitys[165] = new Array('yyw', '宜野湾', 'yiyewan', 'ginowan', '1', 'chongsheng', '冲绳', '', '', 2750, 1, '+09:00');

abroadcitys[166] = new Array('pts', '浦添', 'putianshi', 'urasoe', '1', 'chongsheng', '冲绳', '', '', 2752, 1, '+09:00');

abroadcitys[167] = new Array('mh', '名护', 'minghu', 'nago', '3', 'chongsheng', '冲绳', '', '', 2753, 1, '+09:00');

abroadcitys[168] = new Array('mm', '糸满', 'miman', 'itoman', '3', 'chongsheng', '冲绳', '', '', 2754, 1, '+09:00');

abroadcitys[169] = new Array('fjc', '丰见城', 'fengjiancheng', 'tomigusuku', '2', 'chongsheng', '冲绳', '', '', 2755, 1, '+09:00');

abroadcitys[170] = new Array('ylm', '宇流麻', 'yuliuma', 'uruma', '1', 'chongsheng', '冲绳', '', '', 2756, 1, '+09:00');

abroadcitys[171] = new Array('nc', '南城', 'nancheng', 'nanjo', '2', 'chongsheng', '冲绳', '', '', 2758, 1, '+09:00');

abroadcitys[172] = new Array('gt', '国头', 'guotou', 'kunigami', '9', 'chongsheng', '冲绳', '', '', 2759, 1, '+09:00');

abroadcitys[173] = new Array('zt', '中头', 'zhongtou', 'nakagami', '4', 'chongsheng', '冲绳', '', '', 2760, 1, '+09:00');

abroadcitys[174] = new Array('boracay', '长滩岛', 'boracay', 'boracay', '12', 'ximishayan', '西米沙鄢', '', '', 2851, 1, '+08:00');

abroadcitys[175] = new Array('rh', '热海', 'rehai', 'atami', '2', 'jinggang', '静冈', '', '', 2853, 1, '+09:00');

abroadcitys[176] = new Array('coquitlam', '高贵林', 'coquitlam', 'coquitlam', '6', '', '不列颠哥伦比亚省', '', '', 2743, 1, '-08:00');

abroadcitys[177] = new Array('xz', '小樽', 'xiaozun', 'otaru', '2', 'beihaidao', '北海道', '', '', 2765, 1, '+9:00');

abroadcitys[178] = new Array('jb', '江别', 'jiangbie', 'ebetsu', '2', 'beihaidao', '北海道', '', '', 2777, 1, '+9:00');

abroadcitys[179] = new Array('kaerjiali', '卡尔加里', 'kaerjiali', 'calgary', '1', '', '艾伯塔省', '', '', 2798, 1, '-7:00');

abroadcitys[180] = new Array('wgh', '温哥华', 'wengehua', 'vancouver', '19', '', '不列颠哥伦比亚省', '', '', 2801, 1, '-8:00');

abroadcitys[181] = new Array('westvancou', '西温', 'westvancouver', 'westwen', '2', '', '不列颠哥伦比亚省', '', '', 2802, 1, '-8:00');

abroadcitys[182] = new Array('richmond', '列治文', 'richmond', 'richmondcan', '24', '', '不列颠哥伦比亚省', '', '', 2803, 1, '-8:00');

abroadcitys[183] = new Array('burnaby', '本那比', 'burnaby', 'benabi', '9', '', '不列颠哥伦比亚省', '', '', 2804, 1, '-8:00');

abroadcitys[184] = new Array('surrey', '素里', 'surrey', 'suri', '5', '', '不列颠哥伦比亚省', '', '', 2805, 1, '-8:00');

abroadcitys[185] = new Array('whiterock', '白石', 'whiterock', 'whitestone', '1', '', '不列颠哥伦比亚省', '', '', 2806, 1, '-8:00');

abroadcitys[186] = new Array('newwestmin', '新威斯敏斯特', 'newwestminster', 'newwestminster', '2', '', '不列颠哥伦比亚省', '', '', 2808, 1, '-8:00');

abroadcitys[187] = new Array('fsjt', '富士吉田', 'fushijitian', 'fujiyoshida', '1', 'shanli', '山梨', '', '', 2810, 1, '+09:00');

abroadcitys[188] = new Array('szh', '山中湖', 'shanzhonghu', 'yamanakako', '1', 'shanli', '山梨', '', '', 2831, 1, '+09:00');

abroadcitys[189] = new Array('fshkh', '富士河口湖', 'fushihekouhu', 'fujikawaguchiko', '6', 'shanli', '山梨', '', '', 2833, 1, '+09:00');

abroadcitys[190] = new Array('queenstown', '皇后镇', 'queenstown', 'queenstown', '1', '', '奥塔戈', '', '', 2848, 1, '+12:00');

abroadcitys[191] = new Array('istanbul', '伊斯坦布尔', 'istanbul', 'istanbul', '7', 'istanbul', '伊斯坦布尔', '', '', 2849, 1, '+2:00');

abroadcitys[192] = new Array('fuguodao', '富国岛', 'fuguodao', 'fuguodao', '1', 'jianjiang', '坚江', '', '', 2850, 1, '+7:00');

abroadcitys[193] = new Array('zbxj', '足柄下', 'zubingxia', 'ashigarashimo', '3', 'shennaichuan', '神奈川', '', '', 2854, 1, '+09:00');

abroadcitys[194] = new Array('mtle', '蒙特利尔', 'mengtelier', 'montreal', '13', '', '魁北克省', '', '', 2855, 1, '-04:00');

abroadcitys[195] = new Array('wotaihua', '渥太华', 'wth', 'ottawa', '4', '', '安大略省', '', '', 2856, 1, '-06:00');

abroadcitys[196] = new Array('nyjlpbc', '尼亚加拉瀑布城', 'niyajialapubucheng', 'niagarafalls', '2', '', '安大略省', '', '', 2857, 1, '-06:00');

abroadcitys[197] = new Array('lkw', '兰卡威', 'lankawei', 'pulaulangkawi', '1', '', '吉打', '', '', 2858, 1, '+08:00');

abroadcitys[198] = new Array('yintelaken', '因特拉肯', 'yintelaken', 'interlaken', '20', '', '伯尔尼', '', '', 2876, 1, '+01:00');

abroadcitys[199] = new Array('bkl', '博卡拉', 'bokala', 'pokhara', '8', 'gandaji', '甘达基区', '', '', 2879, 1, '+05:45');

abroadcitys[200] = new Array('sw', '宿务', 'suwu', 'cebu', '2', 'zhongmishayan', '中米沙鄢', '', '', 2881, 1, '+08:00');

abroadcitys[201] = new Array('bhd', '薄荷岛', 'bohedao', 'boholisland', '6', 'zhongmishayan', '中米沙鄢', '', '', 2882, 1, '+08:00');

abroadcitys[202] = new Array('rg', '日光', 'riguang', 'nikko', '4', 'limu', '枥木', '', '', 2891, 1, '+09:00');

abroadcitys[203] = new Array('lc', '镰仓', 'liancang', 'kamakura', '3', 'shennaichuan', '神奈川', '', '', 2896, 1, '+9:00');

abroadcitys[204] = new Array('luotuoluwa', '罗托鲁瓦', 'luotuoluwashi', 'rotorua', '1', '', '普伦蒂湾', '', '', 2899, 1, '+12:00');

abroadcitys[205] = new Array('gechangxia', '阁昌', 'gechangxian', 'gechangxian', '2', 'dalefu', '达叻', '', '', 2902, 1, '+07:00');

abroadcitys[206] = new Array('jujun', '橘郡', 'jujun', 'jujun', '6', '', '加利福尼亚', '', '', 2903, 1, '-08:00');

abroadcitys[207] = new Array('ndl', '南都留', 'nanduliu', 'minamitsuru', '3', 'shanli', '山梨', '', '', 2921, 1, '+09:00');

abroadcitys[208] = new Array('cj', '草加', 'caojia', 'soka', '1', 'qiyu', '埼玉', '', '', 2939, 1, '+09：00');

abroadcitys[209] = new Array('ct', '成田', 'chengtian', 'narita', '1', 'qianye', '千叶', '', '', 2952, 1, '+09：00');

abroadcitys[210] = new Array('mnx', '米努肖', 'minvxiao', 'minusio', '1', 'tiqienuo', '提契诺', '', '', 3009, 1, '+1:00');

abroadcitys[211] = new Array('lbd', '丽贝岛', 'libeidao', 'kohlipe', '1', 'shadun', '沙敦府', '', '', 3010, 1, '+07:00');

abroadcitys[212] = new Array('cs', '长生', 'changshengjun', 'tyouseigun', '2', 'qianye', '千叶', '', '', 3011, 1, '+09:00');

abroadcitys[213] = new Array('xqj', '香取', 'xiangqujun', 'katorigun', '1', 'qianye', '千叶', '', '', 3018, 1, '+09:00');
...
// remotejs start from https://player.youku.com/jsapi 08-19 18:21:32
/**
 * dispatch
 * dispatch 2019-02-25
 * for phone
...
YoukuPlayerSelect.prototype = {
    ...
    selectMobileH5: function () {
        ...
        var config = {
            ...
            logconfig: {}, //统计扩展参数，包括aplus接口中的全局对象时数据，用于传递给统计接口
            adConfig: {}, //广告扩展参数
...
//        $('#abrd').click();
    ...
    var newDate = new execCalendar('#startenddate', {
        abroad: isTrue,
        cityName: searcherCityName,
