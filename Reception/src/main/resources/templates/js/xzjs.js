...
(function() {
 ...
 var xzRegularExpression={a:1,isNum:/^\d{1,}$/,isMobile:/^\d{11}$/,isMobileWithSplit:/^[\d-]{10,}$/,isUsername:/^[\w|\u4E00-\u9FA5|\u3400-\u4DB5|\uE815-\uE864|\u9FA6-\u9FBB]*$/,isChinese:/^[\u4E00-\u9FA5|\u3400-\u4DB5|\uE815-\uE864|\u9FA6-\u9FBB]+$/,simpleMobile:/^\d{11}$/,mobile:/^1((2[7])|(3[0-9])|(4[5-9])|(5[0-9])|(6[124567])|(7[0-8])|(8[0-9])|(9[0-9]))\d{8}$/,password:/^(?![a-zA-Z]+$)(?![A-Z0-9]+$)(?![A-Z\W*!@.\-? : ;|$#%^&()_+=\[\]\\\/{}<>",~`']+$)(?![a-z0-9]+$)(?![a-z\W*!@.\-? : ;|$#%^&()_+=\[\]\\\/{}<>",~`']+$)(?![0-9\W*!@.\-? : ;|$#%^&()_+=\[\]\\\/{}<>",~`']+$)[a-zA-Z0-9\W_!@#$%^&*`~()-+=]{8,16}$/,numbers:/[1-9][0-9]{4}/,simpleEmail:/^.*?@.+$/,email:/^[a-zA-Z0-9_\.\-]+@[a-zA-Z0-9_\-]+(\.[a-zA-Z0-9_\-]+)+[a-zA-Z]+$/,passport:/^[\d\w]{4,20}$/,inviteCode:/^[A-Z0-9]{7,15}$/,simpleDate:/^([0-9]{4})-([0-9]{2})-([0-9]{2})$/,simpleDateTime:/^[1-2][0-9]{3}-[0-1][0-9]-[0-3][0-9] [0-2][0-9](:[0-5][0-9]){1,2}$/,isRealName:/^[\u4E00-\u9FFF\u3400-\u4DBF\uF900-\uFAFF]+(·[\u4E00-\u9FFF\u3400-\u4DBF\uF900-\uFAFF]+|•[\u4E00-\u9FFF\u3400-\u4DBF\uF900-\uFAFF]+)*$/,isRealNameForeign:/^[^\～！@#¥%……&*（）——\+\-\=「」|【】、：“；‘《》？，。/~`\!\$\^\(\)_\{\}\|\[\]\:";'<>\?,\.\/]{1,50}$/}; 
 window.captchaModel = {
...
var searchAbout = {
  ...
  transFormSearchRes:function(resData){ // 转换搜索结果格式
    var listArr  = [(resData.city||[]),(resData.landmarkAndDistrict||[]),(resData.baiduLandmark||[])], listHtml='';
