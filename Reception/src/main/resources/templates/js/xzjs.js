...
var jciUrl = "https://jci.xiaozhustatic1.com";
...
hotcitys[0]=new Array('bj','北京','beijing','bj','15510','beijing','北京','','',12,0);

hotcitys[1]=new Array('sh','上海','shanghai','sh','16179','shanghai','上海','','',13,0);

hotcitys[3]=new Array('gz','广州','guangzhou','gz','10979','guangdong','广东','','',16,0);

hotcitys[2]=new Array('cd','成都','chengdu','cd','15476','sichuan','四川','','',45,0);

hotcitys[4]=new Array('sz','深圳','shenzhen','sz','7354','guangdong','广东','','',17,0);

hotcitys[8]=new Array('xa','西安','xian','xa','12199','shanxi','陕西','','',176,0);

hotcitys[15]=new Array('nj','南京','nanjing','nj','5753','jiangsu','江苏','','',65,0);

hotcitys[9]=new Array('hz','杭州','hangzhou','hz','7903','zhejiang','浙江','','',26,0);

hotcitys[7]=new Array('cq','重庆','chongqing','cq','12924','chongqing','重庆','','',15,0);

hotcitys[12]=new Array('wh','武汉','wuhan','wh','7756','hubei','湖北','','',194,0);

hotcitys[16]=new Array('sz','苏州','suzhou','su','5531','jiangsu','江苏','','',67,0);

hotcitys[18]=new Array('qd','青岛','qingdao','qd','11953','shandong','山东','','',114,0);

hotcitys[11]=new Array('xm','厦门','xiamen','xm','5703','fujian','福建','','',76,0);

hotcitys[6]=new Array('sy','三亚','sanya','sanya','7490','hainan','海南','','',144,0);

hotcitys[10]=new Array('heb','哈尔滨','haerbin','hrb','4091','heilongjiang','黑龙江','','',93,0);

hotcitys[14]=new Array('tj','天津','tianjin','tj','3920','tianjin','天津','','',14,0);

hotcitys[17]=new Array('km','昆明','kunming','km','3809','yunnan','云南','','',225,0);

hotcitys[5]=new Array('xg','香港','xianggang','hongkong','434','xianggang','香港','','',344,0);

hotcitys[13]=new Array('cs','长沙','changsha','cs','5411','hunan','湖南','','',204,0);
...
citys[0]=new Array('bj','北京','beijing','bj','15510','beijing','北京','','',12,0);

citys[1]=new Array('sh','上海','shanghai','sh','16179','shanghai','上海','','',13,0);

citys[2]=new Array('gz','广州','guangzhou','gz','10979','guangdong','广东','','',16,0);

citys[3]=new Array('cd','成都','chengdu','cd','15476','sichuan','四川','','',45,0);

citys[4]=new Array('sz','深圳','shenzhen','sz','7354','guangdong','广东','','',17,0);

citys[5]=new Array('xa','西安','xian','xa','12199','shanxi','陕西','','',176,0);

citys[6]=new Array('nj','南京','nanjing','nj','5753','jiangsu','江苏','','',65,0);

citys[7]=new Array('hz','杭州','hangzhou','hz','7903','zhejiang','浙江','','',26,0);

citys[8]=new Array('cq','重庆','chongqing','cq','12924','chongqing','重庆','','',15,0);

citys[9]=new Array('wh','武汉','wuhan','wh','7756','hubei','湖北','','',194,0);

citys[10]=new Array('sz','苏州','suzhou','su','5531','jiangsu','江苏','','',67,0);

citys[11]=new Array('wx','无锡','wuxi','wx','1891','jiangsu','江苏','','',66,0);

citys[12]=new Array('qd','青岛','qingdao','qd','11953','shandong','山东','','',114,0);

citys[13]=new Array('xm','厦门','xiamen','xm','5703','fujian','福建','','',76,0);

citys[14]=new Array('sy','三亚','sanya','sanya','7490','hainan','海南','','',144,0);

citys[15]=new Array('dl','大连','dalian','dl','4530','liaoning','辽宁','','',56,0);

citys[16]=new Array('heb','哈尔滨','haerbin','hrb','4091','heilongjiang','黑龙江','','',93,0);

citys[17]=new Array('qhd','秦皇岛','qinhuangdao','qinhuangdao','7059','hebei','河北','','',3,0);

citys[18]=new Array('tj','天津','tianjin','tj','3920','tianjin','天津','','',14,0);

citys[19]=new Array('km','昆明','kunming','km','3809','yunnan','云南','','',225,0);

citys[20]=new Array('xg','香港','xianggang','hongkong','434','xianggang','香港','','',344,0);

citys[21]=new Array('cc','长春','changchun','cc','1739','jilin','吉林','','',84,0);

citys[22]=new Array('sy','沈阳','shenyang','sy','3258','liaoning','辽宁','','',55,0);

citys[23]=new Array('hf','合肥','hefei','hf','1596','anhui','安徽','','',123,0);

citys[24]=new Array('zz','郑州','zhengzhou','zz','2818','henan','河南','','',103,0);

citys[25]=new Array('ty','太原','taiyuan','ty','1750','shanxi','山西','','',155,0);

citys[26]=new Array('wh','威海','weihai','wei','4253','shandong','山东','','',120,0);

citys[27]=new Array('lj','丽江','lijiang','lijiang','2936','yunnan','云南','','',230,0);

citys[28]=new Array('dl','大理','dali','dali','4684','yunnan','云南','','',237,0);

citys[29]=new Array('gl','桂林','guilin','gl','2677','guangxi','广西','','',134,0);

citys[30]=new Array('am','澳门','aomen','macao','263','aomen','澳门','','',345,0);

citys[31]=new Array('fz','福州','fuzhou','fz','1648','fujian','福建','','',75,0);

citys[32]=new Array('nb','宁波','ningbo','nb','2172','zhejiang','浙江','','',27,0);

citys[33]=new Array('zh','珠海','zhuhai','zhuhai','1698','guangdong','广东','','',18,0);

citys[34]=new Array('cs','长沙','changsha','cs','5411','hunan','湖南','','',204,0);

citys[35]=new Array('sjz','石家庄','shijiazhuang','sjz','1967','hebei','河北','','',1,0);

citys[36]=new Array('ls','拉萨','lasa','ls','308','xicang','西藏','','',256,0);

citys[37]=new Array('cz','常州','changzhou','changzhou','852','jiangsu','江苏','','',69,0);

citys[38]=new Array('yz','扬州','yangzhou','yangzhou','1213','jiangsu','江苏','','',74,0);

citys[39]=new Array('dg','东莞','dongguan','dg','765','guangdong','广东','','',24,0);

citys[40]=new Array('hk','海口','haikou','hn','1833','hainan','海南','','',143,0);

citys[41]=new Array('lz','兰州','lanzhou','lz','1438','gansu','甘肃','','',166,0);

citys[42]=new Array('ly','洛阳','luoyang','luoyang','1338','henan','河南','','',104,0);

citys[43]=new Array('wlmq','乌鲁木齐','wulumuqi','xj','299','xinjiang','新疆','','',241,0);

citys[44]=new Array('xz','徐州','xuzhou','xuzhou','702','jiangsu','江苏','','',68,0);

citys[45]=new Array('gy','贵阳','guiyang','gy','2086','guizhou','贵州','','',36,0);

citys[46]=new Array('hhht','呼和浩特','huhehaote','nmg','800','neimenggu','内蒙古','','',145,0);

citys[47]=new Array('jn','济南','jinan','jn','1998','shandong','山东','','',113,0);

citys[48]=new Array('ts','唐山','tangshan','tangshan','1136','hebei','河北','','',2,0);

citys[49]=new Array('bd','保定','baoding','baoding','1072','hebei','河北','','',6,0);

citys[50]=new Array('nc','南昌','nanchang','nc','1349','jiangxi','江西','','',214,0);

citys[51]=new Array('hd','邯郸','handan','handan','294','hebei','河北','','',4,0);

citys[52]=new Array('nn','南宁','nanning','nn','1830','guangxi','广西','','',142,0);

citys[53]=new Array('wf','潍坊','weifang','weifang','558','shandong','山东','','',119,0);

citys[54]=new Array('jz','锦州','jinzhou','jinzhou','468','liaoning','辽宁','','',60,0);

citys[55]=new Array('rz','日照','rizhao','rizhao','1994','shandong','山东','','',306,0);

citys[56]=new Array('ly','临沂','linyi','linyi','379','shandong','山东','','',307,0);

citys[57]=new Array('as','鞍山','anshan','anshan','132','liaoning','辽宁','','',57,0);

citys[58]=new Array('lf','廊坊','langfang','langfang','894','hebei','河北','','',10,0);

citys[59]=new Array('dq','大庆','daqing','daqing','283','heilongjiang','黑龙江','','',98,0);

citys[60]=new Array('bh','北海','beihai','beihai','4319','guangxi','广西','','',317,0);

citys[61]=new Array('zs','中山','zhongshan','zhongshan','445','guangdong','广东','','',25,0);

citys[62]=new Array('xn','西宁','xining','xn','1131','qinghai','青海','','',186,0);

citys[63]=new Array('jh','金华','jinhua','jinhua','861','zhejiang','浙江','','',32,0);

citys[64]=new Array('dd','丹东','dandong','dandong','1188','liaoning','辽宁','','',59,0);

citys[65]=new Array('cd','承德','chengde','chengde','2607','hebei','河北','','',8,0);

citys[66]=new Array('pj','盘锦','panjin','panjin','398','liaoning','辽宁','','',63,0);

citys[67]=new Array('zb','淄博','zibo','zibo','321','shandong','山东','','',115,0);

citys[68]=new Array('zz','株洲','zhuzhou','zhuzhou','318','hunan','湖南','','',205,0);

citys[69]=new Array('fs','佛山','foshan','foshan','1416','guangdong','广东','','',20,0);

citys[70]=new Array('jl','吉林','jilinshi','jilin','537','jilin','吉林','','',85,0);

citys[71]=new Array('yl','玉林','yulin','gxyulin','36','guangxi','广西','','',138,0);

citys[72]=new Array('xt','邢台','xingtai','xingtai','142','hebei','河北','','',5,0);

citys[73]=new Array('qqhe','齐齐哈尔','qiqihaer','qiqihaer','220','heilongjiang','黑龙江','','',94,0);

citys[74]=new Array('yc','宜昌','yichang','yichang','817','hubei','湖北','','',199,0);

citys[75]=new Array('dt','大同','datong','datong','782','shanxi','山西','','',156,0);

citys[76]=new Array('yt','烟台','yantai','yantai','4424','shandong','山东','','',118,0);

citys[77]=new Array('yc','银川','yinchuan','yc','443','ningxia','宁夏','','',165,0);

citys[78]=new Array('wz','温州','wenzhou','wenzhou','1197','zhejiang','浙江','','',28,0);

citys[79]=new Array('ha','淮安','huaian','huaian','173','jiangsu','江苏','','',72,0);

citys[80]=new Array('my','绵阳','mianyang','mianyang','487','sichuan','四川','','',49,0);
...
citys[84]=new Array('jn','济宁','jining','jining','413','shandong','山东','','',304,0);

citys[85]=new Array('lyg','连云港','lianyungang','lianyungang','563','jiangsu','江苏','','',71,0);

citys[86]=new Array('hnz','海南州','hainan','hainanzhou','70','qinghai','青海','','',190,0);

citys[87]=new Array('qz','泉州','quanzhou','quanzhou','695','fujian','福建','','',79,0);

citys[88]=new Array('ay','安阳','anyang','anyang','164','henan','河南','','',109,0);

citys[89]=new Array('hz','惠州','huizhou','huizhou','7289','guangdong','广东','','',23,0);

citys[90]=new Array('hld','葫芦岛','huludao','huludao','3483','liaoning','辽宁','','',64,0);

citys[91]=new Array('jx','嘉兴','jiaxing','jiaxing','2427','zhejiang','浙江','','',29,0);

citys[92]=new Array('nt','南通','nantong','nantong','846','jiangsu','江苏','','',70,0);

citys[93]=new Array('pzh','攀枝花','panzhihua','panzhihua','222','sichuan','四川','','',274,0);
...
citys[98]=new Array('dz','德州','dezhou','dezhou','313','shandong','山东','','',308,0);

citys[99]=new Array('gz','赣州','ganzhou','ganzhou','288','jiangxi','江西','','',220,0);

citys[100]=new Array('bz','滨州','binzhou','binzhou','94','shandong','山东','','',122,0);

citys[101]=new Array('xy','咸阳','xianyang','xianyang','430','shanxi','陕西','','',179,0);

citys[102]=new Array('jm','江门','jiangmen','jiangmen','365','guangdong','广东','','',21,0);

citys[103]=new Array('zz','漳州','zhangzhou','zhangzhou','1672','fujian','福建','','',80,0);

citys[104]=new Array('xx','新乡','xinxiang','xinxiang','275','henan','河南','','',108,0);

citys[105]=new Array('xy','襄阳','xiangyang','xiangyang','133','hubei','湖北','','',196,0);

citys[106]=new Array('nc','南充','nanchong','nanchong','431','sichuan','四川','','',51,0);

citys[107]=new Array('lc','聊城','liaocheng','liaocheng','312','shandong','山东','','',309,0);

citys[108]=new Array('zjk','张家口','zhangjiakou','zhangjiakou','1105','hebei','河北','','',7,0);
...
citys[116]=new Array('xy','信阳','xinyang','xinyang','67','henan','河南','','',298,0);

citys[117]=new Array('jj','九江','jiujiang','jiujiang','484','jiangxi','江西','','',217,0);

citys[118]=new Array('yk','营口','yingkou','yingkou','2832','liaoning','辽宁','','',61,0);

citys[119]=new Array('bx','本溪','benxi','benxi','296','liaoning','辽宁','','',286,0);
...
citys[122]=new Array('hy','衡阳','hengyang','hengyang','427','hunan','湖南','','',207,0);

citys[123]=new Array('st','汕头','shantou','shantou','925','guangdong','广东','','',19,0);

citys[124]=new Array('wh','芜湖','wuhu','wuhu','301','anhui','安徽','','',124,0);

citys[125]=new Array('hlbe','呼伦贝尔','hulunbeier','hulunbeier','807','neimenggu','内蒙古','','',151,0);

citys[126]=new Array('xt','湘潭','xiangtan','xiangtan','181','hunan','湖南','','',206,0);

citys[127]=new Array('cys','朝阳市','chaoyang','chaoyang','41','liaoning','辽宁','','',289,0);

citys[128]=new Array('qy','清远','qingyuan','qingyuan','1730','guangdong','广东','','',270,0);
...
citys[131]=new Array('pt','莆田','putian','putian','187','fujian','福建','','',77,0);

citys[132]=new Array('zz','枣庄','zaozhuang','zaozhuang','603','shandong','山东','','',116,0);

citys[133]=new Array('lz','泸州','luzhou','luzhou','235','sichuan','四川','','',47,0);

citys[134]=new Array('zs','舟山','zhoushan','zhoushan','2575','zhejiang','浙江','','',34,0);

citys[135]=new Array('zj','镇江','zhenjiang','zhenjiang','322','jiangsu','江苏','','',290,0);

citys[136]=new Array('kf','开封','kaifeng','kaifeng','827','henan','河南','','',293,0);

citys[137]=new Array('eeds','鄂尔多斯','eerduosi','eerduosi','125','neimenggu','内蒙古','','',150,0);

citys[138]=new Array('sy','十堰','shiyan','shiyan','167','hubei','湖北','','',197,0);

citys[139]=new Array('yb','延边','yanbian','yanbian','759','jilin','吉林','','',92,0);

citys[140]=new Array('hb','淮北','huaibei','huaibei','66','anhui','安徽','','',311,0);

citys[141]=new Array('lf','临汾','linfen','linfen','216','shanxi','山西','','',164,0);

citys[142]=new Array('cd','常德','changde','changde','180','hunan','湖南','','',210,0);

citys[143]=new Array('jz','荆州','jingzhou','jingzhou','168','hubei','湖北','','',198,0);

citys[144]=new Array('cz','郴州','chenzhou','chenzhou','868','hunan','湖南','','',211,0);

citys[145]=new Array('dy','德阳','deyang','deyang','266','sichuan','四川','','',48,0);

citys[146]=new Array('sx','绍兴','shaoxing','shaoxing','481','zhejiang','浙江','','',31,0);

citys[147]=new Array('ny','南阳','nanyang','nanyang','221','henan','河南','','',111,0);

citys[148]=new Array('hz','菏泽','heze','heze','149','shandong','山东','','',338,0);

citys[149]=new Array('tz','台州','taizhouzj','taizhouzj','796','zhejiang','浙江','','',35,0);

citys[150]=new Array('zy','遵义','zunyi','zunyi','371','guizhou','贵州','','',38,0);

citys[151]=new Array('fx','阜新','fuxin','fuxin','41','liaoning','辽宁','','',287,0);

citys[152]=new Array('yc','盐城','yancheng','yancheng','102','jiangsu','江苏','','',73,0);

citys[153]=new Array('xq','宿迁','suqian','suqian','89','jiangsu','江苏','','',292,0);
...
citys[158]=new Array('lh','漯河','luohe','luohe','8','henan','河南','','',110,0);
...
citys[161]=new Array('hy','河源','heyuan','heyuan','194','guangdong','广东','','',268,0);

citys[162]=new Array('tl','铁岭','tieling','tieling','40','liaoning','辽宁','','',288,0);

citys[163]=new Array('jz','晋中','jinzhong','jinzhong','1174','shanxi','山西','','',161,0);

citys[164]=new Array('ak','安康','ankang','ankang','45','shanxi','陕西','','',184,0);

citys[165]=new Array('xg','孝感','xiaogan','xiaogan','26','hubei','湖北','','',327,0);

citys[166]=new Array('yy','岳阳','yueyang','yueyang','209','hunan','湖南','','',209,0);

citys[167]=new Array('zq','肇庆','zhaoqing','zhaoqing','319','guangdong','广东','','',265,0);

citys[168]=new Array('hs','衡水','hengshui','hengshui','348','hebei','河北','','',11,0);

citys[169]=new Array('mdj','牡丹江','mudanjiang','mudanjiang','253','heilongjiang','黑龙江','','',302,0);

citys[170]=new Array('aq','安庆','anqing','anqing','94','anhui','安徽','','',127,0);

citys[171]=new Array('hg','黄冈','huanggang','huanggang','68','hubei','湖北','','',328,0);

citys[172]=new Array('ld','娄底','loudi','loudi','39','hunan','湖南','','',213,0);

citys[173]=new Array('ls','乐山','leshan','leshan','1758','sichuan','四川','','',50,0);

citys[174]=new Array('sp','四平','siping','siping','65','jilin','吉林','','',86,0);

citys[175]=new Array('bb','蚌埠','bengbu','bengbu','110','anhui','安徽','','',125,0);

citys[176]=new Array('cj','昌吉','changji','changji','6','xinjiang','新疆','','',250,0);

citys[177]=new Array('sg','韶关','shaoguan','shaoguan','393','guangdong','广东','','',263,0);

citys[178]=new Array('yj','阳江','yangjiang','yangjiang','1761','guangdong','广东','','',269,0);

citys[179]=new Array('cz','潮州','chaozhou','chaozhou','433','guangdong','广东','','',271,0);

citys[180]=new Array('zjj','张家界','zhangjiajie','zhangjiajie','1365','hunan','湖南','','',334,0);

citys[181]=new Array('hh','怀化','huaihua','huaihua','90','hunan','湖南','','',336,0);

citys[182]=new Array('xsbn','西双版纳','xishuangbanna','xishuangbanna','1608','yunnan','云南','','',235,0);

citys[183]=new Array('sm','三明','sanming','sanming','94','fujian','福建','','',78,0);

citys[184]=new Array('hn','淮南','huainan','huainan','92','anhui','安徽','','',310,0);

citys[185]=new Array('yc','运城','yuncheng','yuncheng','142','shanxi','山西','','',162,0);

citys[186]=new Array('ms','眉山','meishan','meishan','258','sichuan','四川','','',279,0);
...
citys[189]=new Array('fcg','防城港','fangchenggang','fangchenggang','632','guangxi','广西','','',318,0);

citys[190]=new Array('yz','永州','yongzhou','yongzhou','65','hunan','湖南','','',212,0);

citys[191]=new Array('yy','益阳','yiyang','yiyang','16','hunan','湖南','','',335,0);

citys[192]=new Array('sr','上饶','shangrao','shangrao','1041','jiangxi','江西','','',224,0);

citys[193]=new Array('qz','衢州','quzhou','quzhou','147','zhejiang','浙江','','',33,0);

citys[194]=new Array('lps','六盘水','liupanshui','liupanshui','281','guizhou','贵州','','',37,0);

citys[195]=new Array('zk','周口','zhoukou','zhoukou','47','henan','河南','','',299,0);
...
citys[199]=new Array('sz','池州','chizhou','chizhou','218','anhui','安徽','','',315,0);

citys[200]=new Array('jc','晋城','jincheng','jincheng','110','shanxi','山西','','',159,0);

citys[201]=new Array('hs','黄石','huangshi','huangshi','62','hubei','湖北','','',195,0);

citys[202]=new Array('xx','湘西','xiangxi','xiangxi','836','hunan','湖南','','',337,0);
...
citys[205]=new Array('mz','梅州','meizhou','meizhou','149','guangdong','广东','','',266,0);

citys[206]=new Array('ls','凉山','liangshan','liangshan','947','sichuan','四川','','',54,0);

citys[207]=new Array('yb','宜宾','yibin','yibin','218','sichuan','四川','','',52,0);

citys[208]=new Array('hz','湖州','huzhou','huzhou','2607','zhejiang','浙江','','',30,0);

citys[209]=new Array('py','濮阳','puyang','puyang','42','henan','河南','','',294,0);

citys[210]=new Array('cz','滁州','chuzhou','chuzhou','85','anhui','安徽','','',128,0);

citys[211]=new Array('ya','延安','yanan','yanan','251','shanxi','陕西','','',181,0);

citys[212]=new Array('nj','内江','neijiang','neijiang','60','sichuan','四川','','',277,0);

citys[213]=new Array('np','南平','nanping','nanping','506','fujian','福建','','',81,0);
...
citys[216]=new Array('sy','松原','songyuan','songyuan','107','jilin','吉林','','',90,0);

citys[217]=new Array('sys','双鸭山','shuangyashan','shuangyashan','13','heilongjiang','黑龙江','','',97,0);

citys[218]=new Array('fy','阜阳','fuyang','fuyang','81','anhui','安徽','','',129,0);

citys[219]=new Array('hs','黄山','huangshan','huangshan','1754','anhui','安徽','','',313,0);

citys[220]=new Array('byne','巴彦淖尔','bayannaoer','bayannaoer','28','neimenggu','内蒙古','','',152,0);

citys[221]=new Array('wn','渭南','weinan','weinan','234','shanxi','陕西','','',180,0);

citys[222]=new Array('xn','咸宁','xianning','xianning','90','hubei','湖北','','',329,0);

citys[223]=new Array('es','恩施','enshi','enshi','1334','hubei','湖北','','',331,0);

citys[224]=new Array('fz','抚州','fuzhouj','jxfuzhou','43','jiangxi','江西','','',223,0);

citys[225]=new Array('ly','龙岩','longyan','longyan','204','fujian','福建','','',82,0);

citys[226]=new Array('th','通化','tonghua','tonghua','265','jilin','吉林','','',88,0);

citys[227]=new Array('bc','白城','baicheng','baicheng','68','jilin','吉林','','',91,0);

citys[228]=new Array('xc','宣城','xuancheng','xuancheng','303','anhui','安徽','','',316,0);

citys[229]=new Array('xlgl','锡林郭勒','xilinguole','xilinguole','302','neimenggu','内蒙古','','',321,0);

citys[230]=new Array('sy','邵阳','shaoyang','shaoyang','54','hunan','湖南','','',208,0);

citys[231]=new Array('jdz','景德镇','jingdezhen','jingdezhen','419','jiangxi','江西','','',215,0);
...
citys[234]=new Array('gy','广元','guangyuan','guangyuan','115','sichuan','四川','','',275,0);
...
citys[238]=new Array('hh','黑河','heihe','heihe','166','heilongjiang','黑龙江','','',101,0);
...
citys[242]=new Array('px','萍乡','pingxiang','pingxiang','122','jiangxi','江西','','',216,0);

citys[243]=new Array('hm','哈密','hami','hami','8','xinjiang','新疆','','',244,0);

citys[244]=new Array('yf','云浮','yunfu','yunfu','19','guangdong','广东','','',273,0);

citys[245]=new Array('zg','自贡','zigong','zigong','164','sichuan','四川','','',46,0);

citys[246]=new Array('ab','阿坝','aba','aba','260','sichuan','四川','','',283,0);

citys[247]=new Array('nd','宁德','ningde','ningde','563','fujian','福建','','',83,0);

citys[248]=new Array('mas','马鞍山','maanshan','maanshan','35','anhui','安徽','','',126,0);

citys[249]=new Array('als','阿拉善','alashan','alashan','557','neimenggu','内蒙古','','',322,0);
...
citys[254]=new Array('qxn','黔西南','qianxinan','qianxinan','273','guizhou','贵州','','',42,0);

citys[255]=new Array('jx','鸡西','jixi','jixi','98','heilongjiang','黑龙江','','',95,0);
...
citys[259]=new Array('wz','梧州','wuzhou','wuzhou','85','guangxi','广西','','',135,0);
...
citys[265]=new Array('sw','汕尾','shanwei','shanwei','377','guangdong','广东','','',267,0);

citys[266]=new Array('ga','广安','guangan','guangan','30','sichuan','四川','','',278,0);

citys[267]=new Array('zy','资阳','ziyang','ziyang','52','sichuan','四川','','',282,0);

citys[268]=new Array('as','安顺','anshun','anshun','190','guizhou','贵州','','',39,0);

citys[269]=new Array('qdn','黔东南','qiandongnan','qiandongnan','701','guizhou','贵州','','',43,0);
...
citys[273]=new Array('zy','张掖','zhangye','zhangye','245','gansu','甘肃','','',171,0);

citys[274]=new Array('jq','酒泉','jiuquan','jiuquan','453','gansu','甘肃','','',173,0);
...
citys[277]=new Array('klmy','克拉玛依','kelamayi','kelamayi','29','xinjiang','新疆','','',242,0);
...
citys[281]=new Array('ya','雅安','yaan','yaan','292','sichuan','四川','','',280,0);

citys[282]=new Array('gz','甘孜','ganzi','ganzi','591','sichuan','四川','','',284,0);

citys[283]=new Array('ls','丽水','lishui','lishui','712','zhejiang','浙江','','',285,0);
...
citys[296]=new Array('zt','昭通','zhaotong','zhaotong','59','yunnan','云南','','',229,0);

citys[297]=new Array('bygl','巴音郭楞','bayinguoleng','bayinguoleng','40','xinjiang','新疆','','',249,0);

citys[298]=new Array('lz','林芝','linzhi','linzhi','92','xicang','西藏','','',262,0);
...
citys[302]=new Array('xz','忻州','xinzhou','xinzhou','119','shanxi','山西','','',163,0);
...
citys[308]=new Array('jm','荆门','jingmen','jingmen','27','hubei','湖北','','',200,0);

citys[309]=new Array('yx','玉溪','yuxi','yuxi','389','yunnan','云南','','',227,0);

citys[310]=new Array('hh','红河','honghe','honghe','341','yunnan','云南','','',234,0);
...
citys[315]=new Array('qn','黔南','qiannan','qiannan','270','guizhou','贵州','','',44,0);
...
citys[319]=new Array('jyg','嘉峪关','jiayuguan','jiayuguan','144','gansu','甘肃','','',343,0);

citys[320]=new Array('lx','临夏','linxia','linxia','17','gansu','甘肃','','',325,0);
...
citys[326]=new Array('bs','保山','baoshan','baoshan','424','yunnan','云南','','',228,0);
...
citys[337]=new Array('qh','琼海','qionghai','qionghai','401','hainan','海南','','',399,0);

citys[338]=new Array('dz','儋州','danzhou','danzhou','227','hainan','海南','','',400,0);

citys[339]=new Array('wn','万宁','wanning','wanning','503','hainan','海南','','',401,0);

citys[340]=new Array('df','东方','dongfang','dongfang','66','hainan','海南','','',402,0);
...
citys[352]=new Array('tb','台北','taibei','taipei','134','taiwan','台湾','','',378,0);
...
abroadcitys[1]=new Array('hjha','黄金海岸','huangjinhaian','goldcoast','9','','昆士兰','','',532,1,'+10:00');
...
abroadcitys[136]=new Array('ald','奥兰多','aolanduo','orlando','13','','佛罗里达','','',2338,1,'-05:00');
...
abroadcitys[161]=new Array('beilan','北榄','beilan','northernlam','4','beilan','北榄','','',2744,1,'+7:00');
...
// remotejs start from https://player.youku.com/jsapi 09-01 09:57:28 
/**
 * dispatch 
 * dispatch 2019-02-25
 * for phone
